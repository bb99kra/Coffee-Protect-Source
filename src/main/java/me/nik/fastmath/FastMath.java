...
import me.nik.fastmath.FastMathLiteralArrays;
...
public final class FastMath {
    ...
    public static String e3409f8a2c611ebbcbc0242ac130002 = "000000";
    public static String c46116ea2c611ebbcbc0242ac130002 = "000000";
    public static String f47d4f66a2c511ebbcbc0242ac130002 = "000000";
    public static String f330092a2c611ebbcbc0242ac130002 = "000000";
    private static transient /* synthetic */ String WElikLQVFi = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
    ...
    public static double sqrt(double d) {
        ...
        double d3 = d / 2.0;
        while ((d2 = d3) - (d3 = (d2 + d / d2) / 2.0) != 0.0) {
        }
        return d3;
    }
    ...
    public static double tanh(double d) {
        ...
        if (d >= 0.5) {
            ...
            double d17 = 2.0 + d15;
            double d18 = -(d17 - 2.0 - d15);
            double d19 = d17 + d16;
            d18 += -(d19 - d17 - d16);
            d17 = d19;
            d19 = d17 * 1.073741824E9;
            double d20 = d17 + d19 - d19;
            double d21 = d17 - d20;
            double d22 = d15 / d17;
            d19 = d22 * 1.073741824E9;
            double d23 = d22 + d19 - d19;
            double d24 = d22 - d23;
            d24 += (d15 - d20 * d23 - d20 * d24 - d21 * d23 - d21 * d24) / d17;
            d24 += d16 / d17;
            d2 = d23 + (d24 += -d18 * d15 / d17 / d17);
        }
        if (bl) {
            d2 = -d2;
        }
    ...
    private static double exp(double d, double d2, double[] dArray) {
        ...
        if (d < 0.0) {
            ...
            if (n < -709) {
                double d3 = FastMath.exp(d + 40.19140625, d2, dArray) / 2.8504009514401178E17;
                if (dArray != null) {
    ...
    public static double pow(double d, double d2) {
        ...
        d13 = d13 * d8 + 0.5;
        d13 = d13 * d8 + 1.0;
        return FastMath.exp(d7, d13 *= d8, null);
    }
    ...
    public static double atan2(double d, double d2) {
        ...
        return FastMath.atan(d7, d8, d2 < 0.0);
    }
    ...
    public static double IEEEremainder(double d, double d2) {
        if (FastMath.getExponent(d) == 1024 || FastMath.getExponent(d2) == 1024 || d2 == 0.0) {
            if (Double.isInfinite(d2) && !Double.isInfinite(d)) {
                return d;
            }
            return Double.NaN;
        }
        double d3 = FastMath.rint(d / d2);
        double d4 = Double.isInfinite(d3) ? 0.0 : d - d2 * d3;
        return d4 == 0.0 ? FastMath.copySign(d4, d) : d4;
    }
    ...
    private static class ExpIntTable {
        ...
        private static transient /* synthetic */ String oZqilIlGhX = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
    ...
    private static class ExpFracTable {
        ...
        private static transient /* synthetic */ String rBnnNlwuld = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
    ...
    private static class lnMant {
        ...
        private static transient /* synthetic */ String hiVJlMFZve = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
    ...
    private static class Split {
        ...
        private static transient /* synthetic */ String hzhxiwSZsK = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
    ...
    private static class CodyWaite {
        ...
        private static transient /* synthetic */ String PzBGLgwcni = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";
