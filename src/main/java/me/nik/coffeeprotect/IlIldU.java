...
import me.nik.coffeeprotect.IlIlxL;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIls;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.PacketWrapper;

class IlIldU {
    private final HashMap<String, Object> IlIlx = new HashMap();
    private static final long a = IlIls.a((long)-6895015336139170863L, (long)-3597889658160185816L, MethodHandles.lookup().lookupClass()).a(250017016030713L);
    private static transient /* synthetic */ String vlGAoBYmEH = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    private IlIldU() {
    }

    void IlIlC(String string, Object object) {
        long l = a ^ 0x3E3E2A8A3AD4L;
        boolean bl = IlIlPA.IlIlf();
        Object object2 = object;
        if (bl && object2 != null) {
            object2 = this.IlIlx.put(string, object);
        }
    }
    ...
    public String toString() {
        ...
        block7: {
            ...
            Set<Map.Entry<String, Object>> set = this.IlIlx.entrySet();
                                                ...
                                                block13: {
                                                    block9: {
                                                        block10: {
                                                            ...
                                                            stringBuilder = stringBuilder2.append(this.IlIlu(entry.getKey())).append(":");
                                                            if (bl) break block7;
                                                            n4 = object instanceof String;
                                                            if (bl) break block9;
                                                            if (n4 == 0) break block10;
                                                            stringBuilder2.append(this.IlIlu(String.valueOf(object)));
                                                            if (!bl) break block11;
                                                        }
    ...
    private String IlIlu(String string) {
        return "\"" + string + "\"";
    }

    IlIldU(IlIlxL ilIlxL) {
        this();
    }
}
