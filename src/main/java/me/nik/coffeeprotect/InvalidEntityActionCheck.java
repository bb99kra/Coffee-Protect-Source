...
@CheckInfo(CP_J="Invalid Entity Action", CP_M="Checks for invalid entity action packets")
public class InvalidEntityActionCheck
extends Check {
    ...
    public InvalidEntityActionCheck(UserData ilIlTM) {
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        ...
        if (string == null) {
            if (n3 > (int)g) {
                return new CheckResult(this, (String)((Object)InvalidEntityActionCheck.a("k", (int)16196, (long)(0xAA80A8653719A15L ^ l))) + n);
            }
            n3 = CP_yR.CP_j(n2) ? 1 : 0;
        }
        if (n3 != 0) {
            return new CheckResult(this, (String)((Object)InvalidEntityActionCheck.a("k", (int)30138, (long)(0x28F5DA68115650E8L ^ l))));
        }
        if (ilIlXk != CP_Xk.START_JUMPING_WITH_HORSE && n != 0) {
            return new CheckResult(this, (String)((Object)InvalidEntityActionCheck.a("k", (int)26603, (long)(0x62B56F5E7E44C2B8L ^ l))));
        }
        return null;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = InvalidEntityActionCheck.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidEntityActionCheck", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            InvalidEntityActionCheck.e[n2] = InvalidEntityActionCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidEntityActionCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidEntityActionCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidEntityActionCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
