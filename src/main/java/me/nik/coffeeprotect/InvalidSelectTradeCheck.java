...
@CheckInfo(CP_J="Invalid Select Trade", CP_M="Checks for invalid select trade packets")
public class InvalidSelectTradeCheck
extends Check {
    private float CP_S = 0.0f;
    private static final long b = CP_s.a(-8572948742620795459L, -1281010806944506672L, MethodHandles.lookup().lookupClass()).a(6406070367394L);
    ...
    public InvalidSelectTradeCheck(UserData ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_SELECT_TRADE_ENABLED.CP_t());
    }
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        ...
        block12: {
            ...
            block11: {
                ...
                block10: {
                    ...
                    block9: {
                        ...
                        if (packetReceiveEvent.getPacketType() != CP_nN.SELECT_TRADE) {
                            return null;
                        }
                        CP_bX ilIlbX = new CP_bX(packetReceiveEvent);
                        n = ilIlbX.CP_v();
                    ...
                    return new CheckResult(this, (String)((Object)InvalidSelectTradeCheck.a("f", (int)20938, (long)(0x328EECDCC99D3A85L ^ l))) + n);
                }
            ...
            if (inventoryView.getType() != InventoryType.MERCHANT) {
                float f = this.CP_S;
                this.CP_S = f + 1.0f;
                return f > 1.0f ? new CheckResult(this, (String)((Object)InvalidSelectTradeCheck.a("f", (int)23327, (long)(0x40E9B5E9F487B051L ^ l)))) : new CP_TE(this, (String)((Object)InvalidSelectTradeCheck.a("f", (int)26833, (long)(0x783566667211039CL ^ l))));
            }
        }
        float f = this.CP_S;
        if (string == null) {
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = InvalidSelectTradeCheck.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidSelectTradeCheck", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            InvalidSelectTradeCheck.e[n2] = InvalidSelectTradeCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidSelectTradeCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidSelectTradeCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidSelectTradeCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
