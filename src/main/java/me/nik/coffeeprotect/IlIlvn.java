...
public class IlIlvn {
    ...
    public IlIlvn(String string, String string2, String string3, String string4, String string5) {
        ...
        if (nArray2 != null) {
            string6 = string6.length() > IlIlvn.a("q", (int)23678, (long)(0x733AB0A027B03608L ^ l)) ? string5.substring(0, (int)IlIlvn.a("q", (int)28583, (long)(0x43C0BEBF40DC85D0L ^ l))) : string5;
        }
        this.IlIlN = string6;
        this.IlIlP = IlIlB;
        if (PacketWrapper.IlIlz() == null) {
            IlIlvm.IlIlQ(new int[3]);
        }
    }

    public IlIlvn(String string, String string2, String string3, String string4, String string5, String string6) {
        this.IlIlU = string;
        this.IlIlh = string2;
        this.IlIlc = string3;
        this.IlIlA = string4;
    ...
    public String toString() {
        ...
        int[] nArray = IlIlvm.IlIlf();
        String string = this.IlIlU + "," + this.IlIlh + "," + this.IlIlc + "," + this.IlIlA + "," + this.IlIlN.replace(",", "") + "," + this.IlIlP;
        if (nArray == null) {
     ...
     */
    static {
        a = IlIls.a((long)-3408079079504716831L, (long)6810429411614152589L, MethodHandles.lookup().lookupClass()).a(41639253274858L);
        ...
        String string = IlIlvn.a(byArray3).intern();
        d = new HashMap(13);
        ...
        b = lArray;
        c = new Integer[2];
        IlIlB = new SimpleDateFormat(string).format(new Date());
    }
    ...
    private static int a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlvn", exception);
            }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlvn" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlvn.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
