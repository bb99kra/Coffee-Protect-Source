...
import me.nik.coffeeprotect.CP_CD;
...
extends CP_O6 {
    ...
    public CP_O4(CP_Tz ilIlTz, CoffeeProtect coffeeProtect, String string) {
    ...
    protected String CP_O() {
        ...
        return CP_rW.CP_W((String)((Object)CP_O4.b("z", (int)17452, (long)(0x78A41F8E77ACC6CFL ^ l))) + this.CP_h + (String)((Object)CP_O4.b("z", (int)12320, (long)(0x1FEF724FC5CCB2CCL ^ l))));
    }

    @Override
    protected int CP_S() {
        long l = c ^ 0x37329F15D959L;
        return (int)CP_O4.d("q", (int)26474, (long)(0x3BF8F0183BD6E078L ^ l));
    }
    ...
    public void CP_a(InventoryClickEvent var1_1) {
        block15: {
            var2_2 = CP_O4.c ^ 93585953340060L;
            ...
            if (var4_4 == 0) {
                ...
                v0 = CP_CD.CP_Y[var6_5.getType().ordinal()];
            }
            switch (v0 ? 1 : 0) {
                case 1: {
                ...
                case 2: {
                    ...
                    switch (v1) {
                        case 473267736: {
                            v1 = (int)var7_6.equals(CP_O4.b("z", (int)29478, (long)(5008913572660817738L ^ var2_2)));
                            if (var4_4 != 0) break;
                            if (v1 == 0) ** GOTO lbl32
                            var8_7 = 0;
                        ...
                        case -1133036644: {
                            v1 = (int)var7_6.equals(CP_O4.b("z", (int)10336, (long)(8683425022936085518L ^ var2_2)));
                            if (var4_4 != 0) break;
                            if (v1 != 0) {
                                var8_7 = 1;
                            }
    ...
    protected void CP_X() {
        ...
        CP_Qb.CP_t(() -> {
            ...
            block8: {
                ...
                Iterator<CP_vn> iterator = this.CP_A.CP_Z().CP_E().CP_V(this.CP_h).iterator();
                n3 = CP_u9.CP_UnderScore();
                block0: while (iterator.hasNext()) {
                    CP_vn ilIlvn = iterator.next();
                    ArrayList<String> arrayList = new ArrayList<String>();
                    arrayList.add("");
                    arrayList.add((String)((Object)CP_O4.b("z", (int)533, (long)(0x485ECE6997CB0E1BL ^ l))) + ilIlvn.CP_d());
                    arrayList.add("");
                    arrayList.add((String)((Object)CP_O4.b("z", (int)31179, (long)(0x4AFF378BA677F5C0L ^ l))) + ilIlvn.CP_j());
                    arrayList.add("");
                    arrayList.add((String)((Object)CP_O4.b("z", (int)25674, (long)(0x4F1B7F2C910AE845L ^ l))) + ilIlvn.CP_L());
                    arrayList.add("");
                    arrayList.add((String)((Object)CP_O4.b("z", (int)24158, (long)(0x4C42A309E1A05253L ^ l))));
                    String string = CP_Li.CP_w(ilIlvn.CP_J(), (int)CP_O4.d("q", (int)31416, (long)(0x18E5F6C0BFDA4E0AL ^ l)));
                    Object object = string.split(System.lineSeparator());
                    int n4 = ((String[])object).length;
                    n2 = 0;
                    if (n3 != 0) {
                        for (int i = v145; i < n4; ++i) {
                            String string2 = object[i];
                            arrayList.add((String)((Object)CP_O4.b("z", (int)14466, (long)(0x1C5C8FE5F2F8B48EL ^ l))) + string2);
                            if (n3 == 0) continue block0;
                            if (n3 != 0) continue;
                        }
                        object = ilIlvn.CP_i();
                        arrayList.add(this.CP_G((String)object, CP_rW.CP_W((String)((Object)CP_O4.b("z", (int)29498, (long)(0x20E508A1C99C7F3DL ^ l))) + (String)object), arrayList));
                        if (n3 != 0) continue;
                    }
                    break block8;
                }
            ...
            while (n < this.CP_S) {
                ...
                CP_O4 ilIlO4 = this;
                if (n3 != 0) {
                    if (ilIlO4.CP_t >= arrayList.size()) break;
                    ilIlO4 = arrayList.get(this.CP_t);
                }
                if (ilIlO4 != null) {
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        CP_O4.c = CP_s.a(7664915932372266702L, 1907288083263249856L, MethodHandles.lookup().lookupClass()).a(224689854321668L);
                        CP_O4.j = new HashMap<K, V>(13);
                        var11 = CP_O4.c ^ 1544024090525L;
...
lbl25:
                        ...
                        while (true) {
                            var20_3[var18_4++] = CP_O4.c(var21_9).intern();
...
lbl51:
                ...
                CP_O4.h = var20_3;
                CP_O4.i = new String[10];
                CP_O4.p = new HashMap<K, V>(13);
...
lbl73:
    ...
    private static String b(int n, long l) {
        ...
        if (i[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_O4", exception);
            }
            ...
            CP_O4.i[n2] = CP_O4.c(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return i[n2];
    }
    ...
    private static CallSite b(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_O4" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_O4.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_O4.class, "d", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
