...
import me.nik.coffeeprotect.CP_PB;
import me.nik.coffeeprotect.CP_Qb;
import me.nik.coffeeprotect.CP_T9;
import me.nik.coffeeprotect.CP_TF;
...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.CP_D1;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.CP_DI;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.CP_P;
...
extends CP_Pw
implements CP_jR {
    private final CoffeeProtect CP_t;
    private final Set<UUID> CP_e;
    private final List<String> CP_o;
    private final List<String> CP_f;
    ...
    public CP_Pt(CoffeeProtect coffeeProtect) {
        long l = a ^ 0x64E145CCB209L;
        super(CP_dF.LOWEST);
        this.CP_e = new HashSet<UUID>();
        String[] stringArray = new String[CP_Pt.b("l", (int)25797, (long)(0x6AB723B3D5D2399AL ^ l))];
        stringArray[0] = CP_Pt.a("x", (int)23718, (long)(0x29891F07BD9AB7C0L ^ l));
        stringArray[1] = CP_Pt.a("x", (int)23490, (long)(0x4CC02C47910530A6L ^ l));
        stringArray[2] = CP_Pt.a("x", (int)12523, (long)(0x6AE2DC17D7BEDB92L ^ l));
        stringArray[3] = CP_Pt.a("x", (int)31861, (long)(0xC35C3CEC0839716L ^ l));
        stringArray[4] = CP_Pt.a("x", (int)1019, (long)(0x6F6ABE613A886899L ^ l));
        stringArray[5] = CP_Pt.a("x", (int)23597, (long)(0x563CBEA435B0B74CL ^ l));
        stringArray[CP_Pt.b("l", (int)25314, (long)(0x621FAD1A509E3FBFL ^ l))] = CP_Pt.a("x", (int)334, (long)(0x7319A71B52F16A26L ^ l));
        stringArray[CP_Pt.b("l", (int)23946, (long)(0x5B4027CD1ACF80D1L ^ l))] = CP_Pt.a("x", (int)9048, (long)(0x4DD3B96CE27DC820L ^ l));
        this.CP_o = Arrays.asList(stringArray);
        int n = CP_Pt.CP_n();
        String[] stringArray2 = new String[CP_Pt.b("l", (int)19567, (long)(0x549181A0BF6F1131L ^ l))];
        stringArray2[0] = CP_Pt.a("x", (int)20485, (long)(0x3CEDB59E9EF3B69L ^ l));
        stringArray2[1] = CP_Pt.a("x", (int)5479, (long)(0x7A143967EA5C7E0DL ^ l));
        stringArray2[2] = CP_Pt.a("x", (int)4475, (long)(0x4899130928B57A1BL ^ l));
        stringArray2[3] = CP_Pt.a("x", (int)13765, (long)(0x606269F3775F5EAEL ^ l));
        stringArray2[4] = CP_Pt.a("x", (int)8769, (long)(0x6AF5E87FB566C92EL ^ l));
        stringArray2[5] = CP_Pt.a("x", (int)14969, (long)(0x1C5CD7AE9AA0D110L ^ l));
        stringArray2[CP_Pt.b("l", (int)14340, (long)(0x60958F47CA42E55EL ^ l))] = CP_Pt.a("x", (int)9231, (long)(0x7D213B31F5CC4F6AL ^ l));
        stringArray2[CP_Pt.b("l", (int)7674, (long)(0x2DBD65D2ADEC40A6L ^ l))] = CP_Pt.a("x", (int)21236, (long)(0x1F099A692F163999L ^ l));
        this.CP_f = Arrays.asList(stringArray2);
        this.CP_t = coffeeProtect;
        if (n != 0) {
            PacketWrapper.CP_e(new int[2]);
        }
    }

    public void CP_q(Player player, CP_Wx ilIlWx) {
        long l = a ^ 0xAC377B460BAL;
        CP_G2 ilIlG2 = CP_r7.CP_b().CP_q().CP_V(player);
        int n = CP_Pt.CP_D();
        Location location = player.getLocation();
        block0 : switch (CP_CF.CP_E[ilIlWx.ordinal()]) {
            case 1: {
                float f = 3.4028234E35f;
                CallSite callSite = CP_Pt.b("l", (int)27254, (long)(0x21E30BBD67D7E59DL ^ l));
                CP_v_ ilIlv_ = new CP_v_(f, f, f);
                CP_D1 ilIlD1 = new CP_D1(ilIlv_, ilIlv_);
                ilIlD1.CP_d(Collections.emptyList());
                ilIlD1.CP_E(CP_P.KEEP_BLOCKS);
                ilIlD1.CP_M(new CP_um<CP_ut>(CP_jn.CP_hm));
                CP_DI ilIlDI = new CP_DI(new CP_um<CP_ut>(CP_jn.CP_hm), true, new CP_v_(location.getX(), location.getY(), location.getZ()), new CP_QG(f, f, f), f, (int)callSite);
                for (int i = 0; i < CP_Pt.b("l", (int)14116, (long)(0x5BADC4DC3E1EB8CEL ^ l)); ++i) {
                    ilIlG2.CP_x(ilIlD1);
                    ilIlG2.CP_x(ilIlDI);
                    if (n == 0) break block0;
                    if (n != 0) continue;
            ...
            case 2: {
                this.CP_e.add(player.getUniqueId());
                if (n != 0) break;
            }
            case 3: {
                boolean bl = this.CP_t.CP_i();
                if (n != 0) {
                    if (bl) {
                        CP_rW.CP_U(new String[]{CP_Pt.a("x", (int)10132, (long)(0x2C06A10CC5049E40L ^ l))});
                        return;
                    }
                    bl = this.CP_e.add(player.getUniqueId());
                }
                if (n != 0) {
                    if (player.getGameMode() != GameMode.SURVIVAL) {
                        player.setGameMode(GameMode.SURVIVAL);
                    }
                    new CP_TF(this, player).runTaskTimer((Plugin)this.CP_t, 0L, 1L);
                }
                if (n != 0) break;
            }
            case 4: {
                ...
                if (n != 0) {
                    if (bl) {
                        CP_rW.CP_U(new String[]{CP_Pt.a("x", (int)22680, (long)(0x64554B25B7A76145L ^ l))});
                        return;
                    }
                    bl = this.CP_e.add(player.getUniqueId());
                }
                new CP_PB(this, location, player).runTaskTimer((Plugin)this.CP_t, 0L, 1L);
                if (n != 0) break;
            }
            case 5: {
                boolean bl = this.CP_t.CP_i();
                ...
                CP_bU ilIlbU = new CP_bU(CP_CH.WIN_GAME, 1.0f);
                new CP_T9(this, player, ilIlbU).runTaskTimerAsynchronously((Plugin)this.CP_t, 0L, 0L);
                if (n != 0) break;
            }
            case 6: {
                boolean bl = this.CP_t.CP_i();
                ...
                new CP_vS(this, player, ilIlG2).runTaskTimerAsynchronously((Plugin)this.CP_t, 0L, (long)CP_Pt.c("x", (int)28561, (long)(0x65FEBD0937CB58D7L ^ l)));
            }
        }
    }
    ...
    public void CP_P(PacketReceiveEvent packetReceiveEvent) {
        ...
        block7: {
            ...
            bl = this.CP_e.contains(packetReceiveEvent.getUser().CP_M());
        }
        if (bl) {
    ...
    @Override
    public void CP_F(UserDisconnectEvent userDisconnectEvent) {
        long l = a ^ 0x282E0F4EEB09L;
        CP_Qb.CP_y(() -> this.CP_e.remove(userDisconnectEvent.getUser().CP_M()), (long)CP_Pt.c("x", (int)18718, (long)(0x5461B0E78E9475EAL ^ l)));
    }
    ...
    static /* synthetic */ List CP_m(CP_Pt ilIlPt) {
        return ilIlPt.CP_o;
    }

    static /* synthetic */ List CP_H(CP_Pt ilIlPt) {
        return ilIlPt.CP_f;
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                CP_Pt.a = CP_s.a(7183996068580144861L, 1711922279806884736L, MethodHandles.lookup().lookupClass()).a(15844057377645L);
                                CP_Pt.d = new HashMap<K, V>(13);
                                CP_Pt.CP_a(0);
                                var22 = CP_Pt.a ^ 50061756776863L;
...
lbl26:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = CP_Pt.a(var32_9).intern();
...
lbl52:
                        ...
                        CP_Pt.b = var31_3;
                        CP_Pt.c = new String[18];
                        CP_Pt.g = new HashMap<K, V>(13);
...
lbl105:
                ...
                CP_Pt.e = var17_12;
                CP_Pt.f = new Integer[8];
                CP_Pt.j = new HashMap<K, V>(13);
...
lbl127:
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_Pt", exception);
            }
            ...
            CP_Pt.c[n2] = CP_Pt.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_Pt" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_Pt.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_Pt.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(CP_Pt.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
