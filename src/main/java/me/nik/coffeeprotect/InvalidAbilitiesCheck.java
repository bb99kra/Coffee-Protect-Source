...
@CheckInfo(CP_J="Invalid Abilities", CP_M="Checks for invalid abilities packets")
public class InvalidAbilitiesCheck
extends Check {
    ...
    public InvalidAbilitiesCheck(UserData ilIlTM) {
    ...
    static {
        ...
        d = InvalidAbilitiesCheck.b(byArray3).intern();
