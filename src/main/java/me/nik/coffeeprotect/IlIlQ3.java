...
class IlIlQ3 {
    ...
    static {
        block39: {
            block38: {
                var11 = IlIls.a((long)1852745790982686632L, (long)3671658069282427989L, MethodHandles.lookup().lookupClass()).a(262923140430917L) ^ 99373712091423L;
...
lbl50:
        ...
        IlIlQ3.IlIlA = new int[IlIlnN.values().length];
        try {
            IlIlQ3.IlIlA[IlIlnN.CREATIVE_INVENTORY_ACTION.ordinal()] = 1;
        }
        catch (NoSuchFieldError var13_11) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.CLICK_WINDOW.ordinal()] = 2;
        }
        catch (NoSuchFieldError var13_12) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_BLOCK_PLACEMENT.ordinal()] = 3;
        }
        catch (NoSuchFieldError var13_13) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.EDIT_BOOK.ordinal()] = 4;
        }
        catch (NoSuchFieldError var13_14) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_POSITION.ordinal()] = 5;
        }
        catch (NoSuchFieldError var13_15) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_POSITION_AND_ROTATION.ordinal()] = (int)var0_3[3];
        }
        catch (NoSuchFieldError var13_16) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_ROTATION.ordinal()] = (int)var0_3[5];
        }
        catch (NoSuchFieldError var13_17) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_FLYING.ordinal()] = (int)var0_3[0];
        }
        catch (NoSuchFieldError var13_18) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PONG.ordinal()] = (int)var0_3[1];
        }
        catch (NoSuchFieldError var13_19) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.WINDOW_CONFIRMATION.ordinal()] = (int)var0_3[2];
        }
        catch (NoSuchFieldError var13_20) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.KEEP_ALIVE.ordinal()] = (int)var0_3[6];
        }
        catch (NoSuchFieldError var13_21) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_LOADED.ordinal()] = (int)var0_3[4];
        }
        catch (NoSuchFieldError var13_22) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.CLIENT_TICK_END.ordinal()] = (int)var0_3[7];
        }
        catch (NoSuchFieldError var13_23) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.ANIMATION.ordinal()] = (int)var0_3[8];
        }
        catch (NoSuchFieldError var13_24) {
            // empty catch block
        }
        try {
            IlIlQ3.IlIlA[IlIlnN.PLAYER_INPUT.ordinal()] = (int)var0_3[9];
        }
