 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.recipe.IlIljZ
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlb4
...
@IlIljl(IlIlJ="Invalid Recipe", IlIlM="Checks for invalid recipe packets")
public class IlIlu4
extends IlIluV {
    private long IlIlV;
    private long IlIlz;
    private static final long b = IlIls.a((long)-4324004807210928911L, (long)540211067550933592L, MethodHandles.lookup().lookupClass()).a(22151571401926L);
    ...
    public IlIlu4(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_RECIPE_ENABLED.IlIlt());
    }
        ...
        block18: {
            ...
            block19: {
                block17: {
                                ...
                                block12: {
                                    ...
                                    block14: {
                                        ...
                                        block13: {
                                            ...
                                            ilIlnN = IlIlnN.SET_DISPLAYED_RECIPE;
                                            if (string != null) break block11;
                                            if (ilIloL != ilIlnN) break block12;
                                            IlIlb4 ilIlb4 = new IlIlb4(packetReceiveEvent);
                                            IlIljZ ilIljZ2 = ilIljZ = ilIlb4.IlIlK();
                                            if (string == null) {
                                                if (ilIljZ2 == null) {
                                                    return null;
                                                }
                                    ...
                                    IlIlTV ilIlTV = new IlIlTV(this, (String)((Object)IlIlu4.a("c", (int)9680, (long)(0x1EAF48972E5E1049L ^ l4))) + n);
                                    return ilIlTV;
                                }
                                packetReceiveEvent2 = packetReceiveEvent;
                                if (string != null) break block15;
                                ilIloL = packetReceiveEvent2.getPacketType();
                                ilIlnN = IlIlnN.CRAFT_RECIPE_REQUEST;
                            }
                            if (ilIloL != ilIlnN) return null;
                            packetReceiveEvent2 = packetReceiveEvent;
                        }
                        l2 = packetReceiveEvent2.IlIlO();
                        long l5 = l2 - this.IlIlV - 0L;
                    ...
                    if (l3 > 0) {
                        return new IlIlTE(this, (String)((Object)IlIlu4.a("c", (int)8704, (long)(0x4251ABFC4C3D9798L ^ l4))));
                    }
                    break block19;
                }
                this.IlIlz = Math.max(0L, this.IlIlz - 1L);
            }
            ilIlu4 = this;
            l = l2;
        }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = IlIlu4.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlu4", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIlu4.e[n2] = IlIlu4.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlu4" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlu4.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
