...
@CheckInfo(CP_J="Invalid Beacon", CP_M="Checks for invalid beacon packets")
public class InvalidBeaconCheck
extends Check {
    private static final long b = CP_s.a(-5467003168796869281L, 7641473696561204733L, MethodHandles.lookup().lookupClass()).a(158026052745513L);
    ...
    public InvalidBeaconCheck(UserData ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_BEACON_ENABLED.CP_t());
    }
        ...
        block13: {
            ...
            block12: {
                ...
                block11: {
                        ...
                        block10: {
                            ...
                            block8: {
                                block7: {
                                    ...
                                    if (packetReceiveEvent.getPacketType() != CP_nN.SET_BEACON_EFFECT) {
                                        return null;
                                    }
                                    CP_b6 ilIlb6 = new CP_b6(packetReceiveEvent);
                                    n3 = ilIlb6.CP_B();
                                    n = ilIlb6.CP_g();
                                    n2 = n3;
                                    object = -1;
                                    ...
                                    n2 = n3;
                                    object = InvalidBeaconCheck.b("k", (int)19745, (long)(0x36A69F0F9D6CD5D1L ^ l));
                                }
                                if (string != null) break block9;
                                if (n2 <= object) break block10;
                            }
                            return new CP_TE(this, (String)((Object)InvalidBeaconCheck.a("v", (int)6257, (long)(0x30FC833108869DA1L ^ l))) + n3);
                        }
                        n2 = n;
                        object = -1;
                    }
                    ...
                    n2 = n;
                    object = InvalidBeaconCheck.b("k", (int)2351, (long)(0x522DD1940B7591DEL ^ l));
                }
                if (n2 <= object) break block13;
            }
            return new CP_TE(this, (String)((Object)InvalidBeaconCheck.a("v", (int)17552, (long)(0x429CEC4804A1C141L ^ l))) + n);
        }
        return null;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = InvalidBeaconCheck.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidBeaconCheck", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            InvalidBeaconCheck.e[n2] = InvalidBeaconCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidBeaconCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidBeaconCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static int b(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        int n = (Integer)objectArray[0];
        long l = (Long)objectArray[1];
        int n2 = InvalidBeaconCheck.b(n, l);
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidBeaconCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(InvalidBeaconCheck.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
