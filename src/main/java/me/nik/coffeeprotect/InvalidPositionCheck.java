...
@CheckInfo(CP_J="Invalid Position", CP_M="Checks for invalid position packets")
public class InvalidPositionCheck
extends Check {
    private CP_CU CP_O;
    private CP_iW CP_o;
    private long CP_D;
    ...
    public InvalidPositionCheck(UserData ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_POSITION_ENABLED.CP_t());
    }
    ...
    private /* synthetic */ void lambda$handle$0(Player player) {
        block5: {
            ...
            if (string == null && bl) {
                bl = player.teleport(this.CP_O.CP_P());
            }
        }
    }

    public static void CP_p(String string) {
        CP_S = string;
    }
        ...
        block23: {
            block22: {
                block24: {
                    block21: {
                        block20: {
                            InvalidPositionCheck.b = CP_s.a(6907381331358088784L, 391193102449454204L, MethodHandles.lookup().lookupClass()).a(208580200663946L);
                            InvalidPositionCheck.f = new HashMap<K, V>(13);
                            InvalidPositionCheck.CP_p(null);
                            var16 = InvalidPositionCheck.b ^ 3592274033359L;
...
lbl26:
                            ...
                            while (true) {
                                var25_3[var23_4++] = InvalidPositionCheck.b(var26_9).intern();
...
lbl52:
                    ...
                    InvalidPositionCheck.d = var25_3;
                    InvalidPositionCheck.e = new String[7];
...
lbl66:
                ...
                ** while (true)
                InvalidPositionCheck.g = ((long)var15_13[0] & 255L) << 56 | ((long)var15_13[1] & 255L) << 48 | ((long)var15_13[2] & 255L) << 40 | ((long)var15_13[3] & 255L) << 32 | ((long)var15_13[4] & 255L) << 24 | ((long)var15_13[5] & 255L) << 16 | ((long)var15_13[6] & 255L) << 8 | (long)var15_13[7] & 255L;
                InvalidPositionCheck.j = new HashMap<K, V>(13);
...
lbl126:
        ...
        InvalidPositionCheck.h = var6_16;
        InvalidPositionCheck.i = new Long[4];
    }
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidPositionCheck", exception);
            }
            ...
            InvalidPositionCheck.e[n2] = InvalidPositionCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidPositionCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidPositionCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static long b(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        int n = (Integer)objectArray[0];
        long l = (Long)objectArray[1];
        long l2 = InvalidPositionCheck.b(n, l);
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidPositionCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(InvalidPositionCheck.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
