...
@CheckInfo(CP_J="Invalid Pick Item", CP_M="Checks for invalid name item packets")
public class InvalidNameItemCheck
extends Check {
    private int CP_T;
    ...
    public InvalidNameItemCheck(UserData ilIlTM) {
        long l = b ^ 0x21B688F61BD5L;
        super(ilIlTM, CP_Oq.CHECKS_INVALID_NAME_ITEM_ENABLED.CP_t());
        if (ilIlTM != null) {
            ClientVersion clientVersion = ilIlTM.CP_E();
            this.CP_T = clientVersion == ClientVersion.UNKNOWN ? (int)InvalidNameItemCheck.a("l", (int)23166, (long)(0x489A9F6323982DD6L ^ l)) : (int)(clientVersion.CP_w(ClientVersion.V_1_17) ? InvalidNameItemCheck.a("l", (int)8850, (long)(0x1C7C3B7977A8D539L ^ l)) : (clientVersion.CP_w(ClientVersion.V_1_12) ? InvalidNameItemCheck.a("l", (int)31706, (long)(0x45F69925F6660C73L ^ l)) : (clientVersion.CP_w(ClientVersion.V_1_11_1) ? InvalidNameItemCheck.a("l", (int)13685, (long)(0x528A727805BCC2D8L ^ l)) : InvalidNameItemCheck.a("l", (int)27928, (long)(0x3A2B8E2F45879AB2L ^ l)))));
        }
    }
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        ...
        if (CP_yR.CP_r(string, this.CP_T)) {
            return new CheckResult(this, d + string);
        }
        return null;
    }
    ...
    static {
        block11: {
            block10: {
                block12: {
                    InvalidNameItemCheck.b = CP_s.a(2046634619713064068L, -8839421064858652971L, MethodHandles.lookup().lookupClass()).a(85108277583985L);
                    var11 = InvalidNameItemCheck.b ^ 1398862130731L;
...
lbl13:
                ...
                ** while (true)
                InvalidNameItemCheck.d = InvalidNameItemCheck.b(var15_3).intern();
                InvalidNameItemCheck.g = new HashMap<K, V>(13);
...
lbl70:
        ...
        InvalidNameItemCheck.e = var6_6;
        InvalidNameItemCheck.f = new Integer[5];
    }
    ...
    private static int a(int n, long l) {
        ...
        if (f[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidNameItemCheck", exception);
            }
            int n3 = (byArray[4] & 0xFF) << 24 | (byArray[5] & 0xFF) << 16 | (byArray[6] & 0xFF) << 8 | byArray[7] & 0xFF;
            InvalidNameItemCheck.f[n2] = n3;
        }
        return f[n2];
    }
    ...
    private static int a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        int n2 = InvalidNameItemCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidNameItemCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidNameItemCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
