...
import me.nik.coffeeprotect.CP_OA;
...
public class CP_Ox
extends CP_O6 {
    private static final Map<String, String> CP_L;
    ...
    public CP_Ox(CP_Tz ilIlTz, CoffeeProtect coffeeProtect) {
    ...
    protected String CP_O() {
        ...
        return CP_rW.CP_W((String)((Object)CP_Ox.b("a", (int)18971, (long)(0x5E57886D2634EDD7L ^ l))));
    }

    @Override
    protected int CP_S() {
        long l = c ^ 0x16AE6208FBD8L;
        return (int)CP_Ox.d("w", (int)7668, (long)(0xE5FC1850395B3E9L ^ l));
    }
    ...
    public void CP_a(InventoryClickEvent var1_1) {
        block17: {
            var2_2 = CP_Ox.c ^ 128098752010269L;
            ...
            if (var4_5 == 0) {
                ...
                v0 = CP_OA.CP_V[var6_4.getType().ordinal()];
            }
            switch (v0 ? 1 : 0) {
                case 1: {
                    var7_6 = ChatColor.stripColor((String)var6_4.getItemMeta().getDisplayName());
                    var8_7 = this.CP_A.CP_R().CP_S();
                    var9_8 = var7_6.replace(" ", "_").toLowerCase() + (String)CP_Ox.b("a", (int)26093, (long)(1891741249432788114L ^ var2_2));
                ...
                case 3: {
                    ...
                    switch (v2) {
                        case 473267736: {
                            v2 = (int)var11_10.equals(CP_Ox.b("a", (int)18706, (long)(6142210862576414809L ^ var2_2)));
                            if (var4_5 != 0) break;
                            if (v2 == 0) ** GOTO lbl46
                            var12_11 = 0;
                        ...
                        case -1133036644: {
                            v2 = (int)var11_10.equals(CP_Ox.b("a", (int)27974, (long)(4014851001489462281L ^ var2_2)));
                            if (var4_5 != 0) break;
                            if (v2 != 0) {
                                var12_11 = 1;
                            }
...
lbl57:
    ...
    protected void CP_X() {
        ...
        block9: {
            ...
            for (String string : CP_L.keySet()) {
                block10: {
                    ...
                    CallSite callSite = CP_Ox.b("a", (int)24666, (long)(0x71B946F5C0B72CDFL ^ l));
                    if (n2 == 0) {
                        stringBuilder = stringBuilder.append((String)((Object)callSite));
                        callSite = this.CP_A.CP_R().CP_S().getBoolean(string + (String)((Object)CP_Ox.b("a", (int)17455, (long)(0x75C611C0ACE40884L ^ l)))) ? CP_Ox.b("a", (int)24598, (long)(0x36E8F37DA2F32CB8L ^ l)) : CP_Ox.b("a", (int)27706, (long)(0x6F785DB0DCB209DL ^ l));
                    }
                    arrayList.add(stringBuilder.append((String)((Object)callSite)).toString());
                    arrayList3.add("");
                    arrayList3.add((String)((Object)CP_Ox.b("a", (int)6641, (long)(0x629A651A3C205557L ^ l))));
                    String string2 = CP_Li.CP_w(CP_L.get(string), (int)CP_Ox.d("w", (int)19484, (long)(0x6395935EA0B6B43EL ^ l)));
                    for (String string3 : string2.split(System.lineSeparator())) {
                        arrayList3.add((String)((Object)CP_Ox.b("a", (int)1338, (long)(0x2B7D177DAB57C997L ^ l))) + string3);
                        if (n2 == 0) {
                            if (n2 == 0) continue;
                        }
                        break block10;
                    ...
                    arrayList3.add("");
                    arrayList3.add((String)((Object)CP_Ox.b("a", (int)7027, (long)(0x4E9924B1AEE2D7D9L ^ l))));
                    arrayList2.add((String)this.CP_q(Material.PAPER, (String)((Object)CP_Ox.b("a", (int)5583, (long)(0x7E3E2664F417596BL ^ l))) + CP_Li.CP_I(string).replace("_", " "), arrayList3));
                }
                if (n2 == 0) continue;
            }
        ...
        while (n < this.CP_S) {
            ...
            CP_Ox ilIlOx = this;
            if (n2 == 0) {
                if (ilIlOx.CP_t >= arrayList2.size()) break;
                ilIlOx = arrayList2.get(this.CP_t);
            }
            if (ilIlOx != null) {
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        CP_Ox.c = CP_s.a(-6975743178167871266L, -6068473527704584968L, MethodHandles.lookup().lookupClass()).a(164132692323560L);
                        var20 = CP_Ox.c ^ 41339714665741L;
                        CP_Ox.j = new HashMap<K, V>(13);
...
lbl25:
                        ...
                        while (true) {
                            var18_3[var16_4++] = CP_Ox.c(var19_9).intern();
...
lbl51:
                ...
                CP_Ox.h = var18_3;
                CP_Ox.i = new String[34];
                CP_Ox.p = new HashMap<K, V>(13);
...
lbl73:
        ...
        CP_Ox.n = var6_12;
        CP_Ox.o = new Integer[2];
        CP_Ox.CP_L = new HashMap<String, String>();
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)15259, (long)(98062580880025549L ^ var20)), (String)CP_Ox.b("a", (int)31416, (long)(9144647633824245500L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)26332, (long)(4670696070202325654L ^ var20)), (String)CP_Ox.b("a", (int)22718, (long)(2889331052505253109L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)13591, (long)(2990003385255012676L ^ var20)), (String)CP_Ox.b("a", (int)1776, (long)(8821284401775385253L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)23417, (long)(6359837074782111525L ^ var20)), (String)CP_Ox.b("a", (int)2671, (long)(8819674463824254523L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)2709, (long)(2094958551934310098L ^ var20)), (String)CP_Ox.b("a", (int)6201, (long)(3452503016908686449L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)20163, (long)(6958526966238302867L ^ var20)), (String)CP_Ox.b("a", (int)10537, (long)(1917342026002052472L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)2637, (long)(6408098622057059844L ^ var20)), (String)CP_Ox.b("a", (int)19114, (long)(2232920250750359293L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)10369, (long)(4014803813441746136L ^ var20)), (String)CP_Ox.b("a", (int)24393, (long)(5696377369537463050L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)7591, (long)(1530942831853502975L ^ var20)), (String)CP_Ox.b("a", (int)30409, (long)(1508421974048991899L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)14693, (long)(8299489459864282411L ^ var20)), (String)CP_Ox.b("a", (int)3429, (long)(148197379642626367L ^ var20)));
        CP_Ox.CP_L.put((String)CP_Ox.b("a", (int)11982, (long)(8162119088943313548L ^ var20)), (String)CP_Ox.b("a", (int)14704, (long)(4016082983288448302L ^ var20)));
    }
    ...
    private static String b(int n, long l) {
        ...
        if (i[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_Ox", exception);
            }
            ...
            CP_Ox.i[n2] = CP_Ox.c(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return i[n2];
    }
    ...
    private static CallSite b(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_Ox" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_Ox.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_Ox.class, "d", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
