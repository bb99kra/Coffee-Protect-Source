...
extends IlIlju {
    ...
    protected String IlIlC() {
        ...
        return IlIljK.a("c", (int)4160, (long)(0x106D849AD02FA86FL ^ l));
    }

    @Override
    protected String IlIlV() {
        long l = a ^ 0x68D2FDEEDE1DL;
        return IlIljK.a("c", (int)17187, (long)(0x39961CE2AAD72196L ^ l));
    }

    @Override
    protected String IlIld() {
        long l = a ^ 0x4285CAEE59CDL;
        return IlIljK.a("c", (int)23887, (long)(0x25A6D1B1903D382FL ^ l));
    }

    @Override
    protected String IlIla() {
        return IlIlx5.INFO.IlIla();
    }
    ...
    protected void IlIlM(CommandSender commandSender, String[] stringArray) {
        ...
        IlIlTM ilIlTM = this.IlIlu.IlIlF().IlIlR(player);
        if (bl) {
            if (ilIlTM == null) {
                return;
            }
            commandSender.sendMessage(IlIlxi.INFO_COMMAND.IlIlF().replace((CharSequence)((Object)IlIljK.a("c", (int)10974, (long)(0x26527611AE346408L ^ l))), IlIlxi.PREFIX.IlIlF()).replace((CharSequence)((Object)IlIljK.a("c", (int)32172, (long)(0x16C323F488CB3379L ^ l))), String.valueOf(ilIlTM.IlIlp().IlIlw())).replace((CharSequence)((Object)IlIljK.a("c", (int)21690, (long)(0x2A06BD67A67B1A62L ^ l))), String.valueOf(ilIlTM.IlIlD().IlIlw())).replace((CharSequence)((Object)IlIljK.a("c", (int)22523, (long)(0x1F94459F0A52192FL ^ l))), ilIlTM.IlIlc()).replace((CharSequence)((Object)IlIljK.a("c", (int)17210, (long)(0x1A31E3A732DD0DE9L ^ l))), ilIlTM.IlIlE().IlIlr()).replace((CharSequence)((Object)IlIljK.a("c", (int)21319, (long)(0xF81D1BB23AD9D97L ^ l))), String.valueOf(ilIlTM.IlIlO())));
        }
    }
    ...
    static {
        block11: {
            block10: {
                IlIljK.a = IlIls.a((long)6162244266829855877L, (long)-8882539702687307592L, MethodHandles.lookup().lookupClass()).a(245656632585412L);
                IlIljK.d = new HashMap<K, V>(13);
                var0 = IlIljK.a ^ 62952211939296L;
...
lbl25:
                ...
                while (true) {
                    var9_3[var7_4++] = IlIljK.a(var10_9).intern();
