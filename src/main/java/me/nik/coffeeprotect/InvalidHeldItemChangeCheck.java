...
@CheckInfo(CP_J="Invalid Held Item Change", CP_M="Checks for invalid held item change packets")
public class InvalidHeldItemChangeCheck
extends Check {
    private int CP_p = -1;
    private int CP_q = 0;
    ...
    public InvalidHeldItemChangeCheck(UserData ilIlTM) {
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        int n;
        block13: {
            InvalidHeldItemChangeCheck ilIluL;
            int n2;
            block14: {
                block12: {
                    InvalidHeldItemChangeCheck ilIluL2;
                    block11: {
                        int n3;
                        String string;
                        long l;
                        block10: {
                            block8: {
                                block9: {
                                    ...
                                    return new CheckResult(this, (String)((Object)InvalidHeldItemChangeCheck.a("c", (int)25924, (long)(0x59B4B7063DE021E4L ^ l))) + n2);
                                }
                                n3 = n2;
                            }
                        ...
                        InvalidHeldItemChangeCheck ilIluL3 = this;
                        ilIluL = ilIluL3;
                        n = ilIluL3.CP_q;
                        if (string != null) break block13;
                        ilIluL.CP_q = n + 1;
                        if (n > 1) {
                            return new CP_TE(this, (String)((Object)InvalidHeldItemChangeCheck.a("c", (int)21403, (long)(0x113EDF557624173AL ^ l))) + n2);
                        }
                        break block14;
                    }
                    ilIluL2 = this;
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = InvalidHeldItemChangeCheck.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidHeldItemChangeCheck", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            InvalidHeldItemChangeCheck.e[n2] = InvalidHeldItemChangeCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidHeldItemChangeCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidHeldItemChangeCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidHeldItemChangeCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
