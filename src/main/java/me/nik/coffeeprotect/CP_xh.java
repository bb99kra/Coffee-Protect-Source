...
public class CP_xh {
    ...
    public CP_xh(JavaPlugin javaPlugin) {
        this.CP_q = javaPlugin;
    }

    /*
     * Loose catch block
     */
    public CP_Cb CP_t(File file) {
        CP_Cb ilIlCb;
        block13: {
            boolean bl;
            int[] nArray;
            block11: {
                block12: {
                    ...
                    nArray = CP_Cf.CP_G();
                    bl = this.CP_q.getDataFolder().exists();
                    ...
                    try {
                        block14: {
                            ...
                            break block14;
                                ...
                                throw CP_xh.a(iOException);
                            }
                        }
                        this.CP_q.getDataFolder().mkdir();
                    }
                    catch (IOException iOException) {
                        throw CP_xh.a(iOException);
                    }
        ...
        try {
            ilIlCb = new CP_Cb(this.CP_D(file), file, this.CP_G(file), this.CP_q);
            if (PacketWrapper.CP_z() == null) {
                CP_Cf.CP_S(new int[2]);
            }
        }
        catch (IOException iOException) {
            throw CP_xh.a(iOException);
     ...
     */
    public Reader CP_D(File var1_1) {
        block13: {
            var2_2 = CP_xh.a ^ 88624853926022L;
            var4_3 = CP_Cf.CP_G();
            v0 = var1_1.exists();
...
lbl18:
                    ...
                    block16: {
                        block15: {
                            ...
                            try {
                                ...
                                v6 = var9_9.replaceAll(Pattern.quote("'"), Matcher.quoteReplacement((String)CP_xh.a("z", (int)3977, (long)(7481863483928329800L ^ var2_2)))).replaceFirst("#", var6_6 + (String)CP_xh.a("z", (int)22384, (long)(2779672976256951986L ^ var2_2)) + var5_4++ + (String)CP_xh.a("z", (int)6335, (long)(2540950862807411064L ^ var2_2))) + "'";
                            }
     ...
     * Could not resolve type clashes
     */
    private int CP_G(File var1_1) {
        block10: {
            var2_2 = CP_xh.a ^ 65680356353570L;
            var4_3 = CP_Cf.CP_G();
            v0 = var1_1.exists();
            if (var4_3 != null) ** GOTO lbl18
            try {
...
lbl18:
    ...
    private String CP_g(String string) {
        String string2;
        block5: {
                        ...
                        block13: {
                            ...
                            block12: {
                                block11: {
                                    block10: {
                                        ...
                                        block8: {
                                            ...
                                            block9: {
                                                ...
                                                bl2 = string2.startsWith(this.CP_r() + (String)((Object)CP_xh.a("z", (int)14705, (long)(0x515BF3A7BFA0D8D0L ^ l))));
                                                ...
                                                if (!string5.startsWith((String)((Object)CP_xh.a("z", (int)27746, (long)(0x1BFDD2F66E70DC5L ^ l))))) break block9;
                                                string4 = string6.substring(0, string6.length() - 1).replaceFirst((String)((Object)CP_xh.a("z", (int)3734, (long)(0x1BAE58D3F130EF3AL ^ l))), (String)((Object)CP_xh.a("z", (int)28630, (long)(0x5CF9A0D5596F0E74L ^ l))));
                                    ...
                                    string4 = string4.replaceAll((String)((Object)CP_xh.a("z", (int)24174, (long)(0xF1878B856363FCBL ^ l))), "'");
                                    if (nArray != null) break block11;
                                    if (bl) break block12;
     ...
     * Could not resolve type clashes
     */
    public void CP_J(String var1_1, File var2_2, boolean var3_3) {
        block81: {
            var4_4 = CP_xh.a ^ 72714855171807L;
            var7_5 = this.CP_g(var1_1).replaceAll((String)CP_xh.a("z", (int)7075, (long)(7802551719430859839L ^ var4_4)), "\n");
            var6_6 = CP_Cf.CP_G();
...
lbl37:
                            ...
                            try {
                                ...
                                var8_7.append((char)CP_xh.b("f", (int)1093, (long)(1397348897931864419L ^ var4_4)));
                            }
                            catch (Throwable v28) {
                                throw CP_xh.a(v28);
                            }
                        }
                        var8_7.append(var14_18).append((char)CP_xh.b("f", (int)11205, (long)(4297167001425381090L ^ var4_4)));
                        var10_10 = var15_19;
                        var11_13 = var17_21;
                        var12_16 = var18_22;
                        v1 = var13_17 = 0;
...
lbl243:
    ...
    public String CP_r() {
        return this.CP_q.getDescription().getName();
    }
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        CP_xh.a = CP_s.a(4654341444940207980L, -1338663462525659416L, MethodHandles.lookup().lookupClass()).a(40396180513134L);
                        CP_xh.d = new HashMap<K, V>(13);
                        var11 = CP_xh.a ^ 77166127758863L;
...
lbl25:
                        ...
                        while (true) {
                            var20_3[var18_4++] = CP_xh.a(var21_9).intern();
...
lbl51:
                ...
                CP_xh.b = var20_3;
                CP_xh.c = new String[9];
                CP_xh.g = new HashMap<K, V>(13);
...
lbl73:
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_xh", exception);
            }
            ...
            CP_xh.c[n2] = CP_xh.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_xh" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_xh.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_xh.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
