...
public class IlIljy
extends IlIlju {
    private static final long a = IlIls.a((long)-3570871936624457788L, (long)-4384268528697976604L, MethodHandles.lookup().lookupClass()).a(172994264061024L);
    ...
    protected String IlIlC() {
        ...
        return IlIljy.a("d", (int)16995, (long)(0xE8C50A647D28376L ^ l));
    }

    @Override
    protected String IlIlV() {
        long l = a ^ 0x4A38F67372B7L;
        return IlIljy.a("d", (int)13482, (long)(0x7164FB0D7F022F27L ^ l));
    }

    @Override
    protected String IlIld() {
        long l = a ^ 0x606FC173F567L;
        return IlIljy.a("d", (int)20922, (long)(0x4A5128CBF5D9CDE4L ^ l));
    }

    @Override
    protected String IlIla() {
        return IlIlx5.DISCONNECT.IlIla();
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = IlIljy.a(byArray3).intern();
            if ((n4 += n3) >= n2) {
                b = stringArray;
                c = new String[3];
                return;
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIljy", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIljy.c[n2] = IlIljy.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIljy" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIljy.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
