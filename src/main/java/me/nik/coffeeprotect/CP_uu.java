...
@CP_jl(CP_J="Invalid Block Placement", CP_M="Checks for invalid block placements")
public class CP_uu
extends CP_uV {
    private long CP_Y;
    private long CP_M;
            ...
            block20: {
                block19: {
                    block18: {
                        block17: {
                            block16: {
                                CP_uu.b = CP_s.a(3548400658391628368L, 2178758214804283373L, MethodHandles.lookup().lookupClass()).a(205999691178231L);
                                CP_uu.f = new HashMap<K, V>(13);
                                var22 = CP_uu.b ^ 3716381410889L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = CP_uu.b(var32_9).intern();
...
lbl51:
                        ...
                        CP_uu.d = var31_3;
                        CP_uu.e = new String[13];
                        CP_uu.i = new HashMap<K, V>(13);
...
lbl73:
                ...
                CP_uu.g = var17_12;
                CP_uu.h = new Integer[3];
                CP_uu.l = new HashMap<K, V>(13);
...
lbl107:
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_uu", exception);
            }
            ...
            CP_uu.e[n2] = CP_uu.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_uu" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])CP_uu.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    CP_uu.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_uu.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(CP_uu.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
