 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlb8
...
@IlIljl(IlIlJ="Invalid Sign", IlIlM="Checks for invalid sign packets")
public class IlIlus
extends IlIluV {
    ...
    public IlIlus(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_SIGN_ENABLED.IlIlt());
    }
    ...
    public IlIlTV IlIlh(PacketReceiveEvent var1_1) {
        block13: {
            block12: {
                var2_2 = IlIlus.b ^ 60096206822510L;
                var4_3 = IlIlu7.IlIlq();
                if (var1_1.getPacketType() != IlIlnN.UPDATE_SIGN) {
                    return null;
                }
                var5_4 = new IlIlb8(var1_1);
                var6_5 = var5_4.IlIlE();
                if (!IlIlOq.CHECKS_INVALID_SIGN_FIX_SIGNS.IlIlt()) break block12;
                var7_6 = IlIlZ6.IlIlU((String[])var6_5, (Function<String, String>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, IlIlQ(java.lang.String ), (Ljava/lang/String;)Ljava/lang/String;)());
                v0 = (int)Arrays.equals(var6_5, var7_6);
                if (var4_3 != null) break block13;
                if (v0 == 0) {
                    var5_4.IlIl_(IlIlZ6.IlIlU((String[])var6_5, (Function<String, String>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, IlIlQ(java.lang.String ), (Ljava/lang/String;)Ljava/lang/String;)()));
        ...
        for (var9_8 = 0; var9_8 < var8_7; ++var9_8) {
            block14: {
                block15: {
                    ...
                    cfr_temp_0 = this.IlIlw.IlIl_() - IlIlus.g;
                    v1 = cfr_temp_0 == 0L ? 0 : (cfr_temp_0 < 0L ? -1 : 1);
                    if (var4_3 != null) break block14;
                    if (v1 <= 0) break block15;
                    v1 = (long)this.IlIlw.IlIlp().IlIlj();
                    if (var4_3 != null) break block14;
                    if (v1 != false) {
                        v1 = (long)IlIlyR.IlIlr((String)var10_9, IlIlOq.CHECKS_INVALID_SIGN_MAX_LENGTH.IlIlj());
                        if (var4_3 == null) {
                            if (v1 != false) {
                                return new IlIlTV(this, (String)IlIlus.a("n", (int)31358, (long)(2180340854342631395L ^ var2_2)));
                            } else {
                                ** GOTO lbl34
                            }
                        } else {
...
lbl33:
                ...
                v1 = (long)IlIlLi.IlIlz(var10_9.toLowerCase(), new String[]{IlIlus.a("n", (int)13739, (long)(7269851395098308661L ^ var2_2)), IlIlus.a("n", (int)16306, (long)(7870431326068767278L ^ var2_2))});
            }
            if (v1 == false) continue;
            return new IlIlTE(this, (String)IlIlus.a("n", (int)27192, (long)(9072852971854278567L ^ var2_2)));
        }
        return null;
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    IlIlus.b = IlIls.a((long)-3571352175982438078L, (long)-8739882020379759471L, MethodHandles.lookup().lookupClass()).a(130819544933410L);
                    IlIlus.f = new HashMap<K, V>(13);
                    var5 = IlIlus.b ^ 59273370344723L;
...
lbl25:
                    ...
                    while (true) {
                        var14_3[var12_4++] = IlIlus.b(var15_9).intern();
...
lbl65:
        ...
        ** while (true)
        IlIlus.g = ((long)var4_13[0] & 255L) << 56 | ((long)var4_13[1] & 255L) << 48 | ((long)var4_13[2] & 255L) << 40 | ((long)var4_13[3] & 255L) << 32 | ((long)var4_13[4] & 255L) << 24 | ((long)var4_13[5] & 255L) << 16 | ((long)var4_13[6] & 255L) << 8 | (long)var4_13[7] & 255L;
    }
