...
import me.nik.coffeeprotect.IlIlvy;
...
extends IlIlO6 {
    ...
    public IlIlOB(IlIlTz ilIlTz, CoffeeProtect coffeeProtect) {
    ...
    protected String IlIlO() {
        ...
        return IlIlrW.IlIlW((String)((Object)IlIlOB.b("j", (int)15400, (long)(0x637EE12CBBA002F6L ^ l))));
    }

    @Override
    protected int IlIlS() {
        long l = c ^ 0x6D7FA75D379DL;
        return (int)IlIlOB.d("w", (int)24598, (long)(0x528368B2F26FBA2EL ^ l));
    }
    ...
    public void IlIla(InventoryClickEvent var1_1) {
        block15: {
            var2_2 = IlIlOB.c ^ 16838784832600L;
            ...
            if (var4_4 == 0) {
                ...
                v0 = IlIlvy.IlIlu[var6_5.getType().ordinal()];
            }
            switch (v0 ? 1 : 0) {
                case 1: {
                ...
                case 2: {
                    ...
                    switch (v1) {
                        case 473267736: {
                            v1 = (int)var7_6.equals(IlIlOB.b("j", (int)2929, (long)(5925090384039602984L ^ var2_2)));
                            if (var4_4 != 0) break;
                            if (v1 == 0) ** GOTO lbl32
                            var8_7 = 0;
                        ...
                        case -1133036644: {
                            v1 = (int)var7_6.equals(IlIlOB.b("j", (int)25517, (long)(1282433131982685173L ^ var2_2)));
                            if (var4_4 != 0) break;
                            if (v1 != 0) {
                                var8_7 = 1;
                            }
    ...
    protected void IlIlX() {
        ...
        IlIlQb.IlIlt(() -> {
            ...
            block8: {
                ...
                Iterator<IlIlvn> iterator = this.IlIlA.IlIlZ().IlIlE().IlIlz().iterator();
                n3 = IlIlu9.IlIl_();
                block0: while (iterator.hasNext()) {
                    IlIlvn ilIlvn = iterator.next();
                    ArrayList<String> arrayList = new ArrayList<String>();
                    arrayList.add("");
                    arrayList.add((String)((Object)IlIlOB.b("j", (int)30929, (long)(0x26ED338194D8B712L ^ l))) + ilIlvn.IlIld());
                    arrayList.add("");
                    arrayList.add((String)((Object)IlIlOB.b("j", (int)13634, (long)(0x5F44C1DE27277A87L ^ l))) + ilIlvn.IlIlj());
                    arrayList.add("");
                    arrayList.add((String)((Object)IlIlOB.b("j", (int)6877, (long)(0x14E99264203ED51FL ^ l))) + ilIlvn.IlIlL());
                    arrayList.add("");
                    arrayList.add((String)((Object)IlIlOB.b("j", (int)18597, (long)(0x23BC8C2617ED8762L ^ l))));
                    String string = IlIlLi.IlIlw(ilIlvn.IlIlJ(), (int)IlIlOB.d("w", (int)26018, (long)(0x1FBC9BC1234EF3C7L ^ l)));
                    Object object = string.split(System.lineSeparator());
                    int n4 = ((String[])object).length;
                    n2 = 0;
                    if (n3 != 0) {
                        for (int i = v574710; i < n4; ++i) {
                            String string2 = object[i];
                            arrayList.add((String)((Object)IlIlOB.b("j", (int)32591, (long)(0x54CDF8212A25B080L ^ l))) + string2);
                            if (n3 == 0) continue block0;
                            if (n3 != 0) continue;
                        }
                        object = ilIlvn.IlIli();
                        arrayList.add(this.IlIlG((String)object, IlIlrW.IlIlW((String)((Object)IlIlOB.b("j", (int)17382, (long)(0x3BD80E97C6D18C22L ^ l))) + (String)object), arrayList));
                        if (n3 != 0) continue;
                    }
                    break block8;
                }
            ...
            while (n < this.IlIlS) {
                ...
                IlIlOB ilIlOB = this;
                if (n3 != 0) {
                    if (ilIlOB.IlIlt >= arrayList.size()) break;
                    ilIlOB = arrayList.get(this.IlIlt);
                }
                if (ilIlOB != null) {
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        IlIlOB.c = IlIls.a((long)-3302391859386364708L, (long)3357223510295165665L, MethodHandles.lookup().lookupClass()).a(169945690744208L);
                        IlIlOB.j = new HashMap<K, V>(13);
                        var11 = IlIlOB.c ^ 124416686464969L;
...
lbl25:
                        ...
                        while (true) {
                            var20_3[var18_4++] = IlIlOB.c(var21_9).intern();
...
lbl51:
                ...
                IlIlOB.h = var20_3;
                IlIlOB.i = new String[9];
                IlIlOB.p = new HashMap<K, V>(13);
...
lbl73:
    ...
    private static String b(int n, long l) {
        ...
        if (i[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlOB", exception);
            }
            ...
            IlIlOB.i[n2] = IlIlOB.c(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return i[n2];
    }
    ...
    private static CallSite b(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlOB" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlOB.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlOB.class, "d", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
