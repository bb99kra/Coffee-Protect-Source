 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlbj
...
@IlIljl(IlIlJ="Invalid Pick Item", IlIlM="Checks for invalid name item packets")
public class IlIluX
extends IlIluV {
    private int IlIlT;
    ...
    public IlIluX(IlIlTM ilIlTM) {
        ...
        super(ilIlTM, IlIlOq.CHECKS_INVALID_NAME_ITEM_ENABLED.IlIlt());
        if (ilIlTM != null) {
            ClientVersion clientVersion = ilIlTM.IlIlE();
            this.IlIlT = clientVersion == ClientVersion.UNKNOWN ? (int)IlIluX.a("l", (int)23166, (long)(0x489A9F6323982DD6L ^ l)) : (int)(clientVersion.IlIlw(ClientVersion.V_1_17) ? IlIluX.a("l", (int)8850, (long)(0x1C7C3B7977A8D539L ^ l)) : (clientVersion.IlIlw(ClientVersion.V_1_12) ? IlIluX.a("l", (int)31706, (long)(0x45F69925F6660C73L ^ l)) : (clientVersion.IlIlw(ClientVersion.V_1_11_1) ? IlIluX.a("l", (int)13685, (long)(0x528A727805BCC2D8L ^ l)) : IlIluX.a("l", (int)27928, (long)(0x3A2B8E2F45879AB2L ^ l)))));
        }
    }
    ...
    public IlIlTV IlIlh(PacketReceiveEvent packetReceiveEvent) {
        ...
        if (packetReceiveEvent.getPacketType() != IlIlnN.NAME_ITEM) {
            return null;
        }
        String string = new IlIlbj(packetReceiveEvent).IlIlp();
        if (IlIlyR.IlIlr(string, this.IlIlT)) {
            return new IlIlTV(this, d + string);
        }
        return null;
    }
    ...
    static {
        block11: {
            block10: {
                block12: {
                    IlIluX.b = IlIls.a((long)2046634619713064068L, (long)-8839421064858652971L, MethodHandles.lookup().lookupClass()).a(85108277583985L);
                    var11 = IlIluX.b ^ 1398862130731L;
...
lbl13:
                ...
                ** while (true)
                IlIluX.d = IlIluX.b(var15_3).intern();
                IlIluX.g = new HashMap<K, V>(13);
...
lbl70:
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIluX.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
