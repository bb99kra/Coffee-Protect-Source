...
@CP_jl(CP_J="Invalid Custom Payload", CP_M="Checks for invalid custom payload packets")
public class CP_uK
extends CP_uV {
    ...
    public CP_uK(CP_TM ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_CUSTOM_PAYLOAD_ENABLED.CP_t());
    }

    private static double CP_Z(long l, Location location) {
        return NumberConversions.square((double)((double)CP_uK.CP_E(l) - location.getX())) + NumberConversions.square((double)((double)CP_uK.CP_H(l) - location.getY())) + NumberConversions.square((double)((double)CP_uK.CP_Y(l) - location.getZ()));
    }

    private static int CP_E(long l) {
        long l2 = b ^ 0x48A6FF8B7AABL;
        return (int)(l << 0 >> CP_uK.b("d", (int)30883, (long)(0x6E66A7B700E6A6FDL ^ l2)));
    }

    private static int CP_H(long l) {
        long l2 = b ^ 0xCC31BB343A4L;
        return (int)(l << CP_uK.b("d", (int)17279, (long)(0x470E6F1CD1F52433L ^ l2)) >> CP_uK.b("d", (int)13466, (long)(0x109234A5AB8453DFL ^ l2)));
    }

    private static int CP_Y(long l) {
        long l2 = b ^ 0x1B41C73E5866L;
        return (int)(l << CP_uK.b("d", (int)29811, (long)(0x671E882E59BF88FCL ^ l2)) >> CP_uK.b("d", (int)27371, (long)(0x2E18334602E1679L ^ l2)));
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                CP_uK.b = CP_s.a(3333490147535127281L, -353102473853109420L, MethodHandles.lookup().lookupClass()).a(28682455317985L);
                                CP_uK.f = new HashMap<K, V>(13);
                                var22 = CP_uK.b ^ 86440510685007L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = CP_uK.b(var32_9).intern();
...
lbl51:
                        ...
                        CP_uK.d = var31_3;
                        CP_uK.e = new String[40];
                        CP_uK.i = new HashMap<K, V>(13);
...
lbl104:
                ...
                CP_uK.g = var17_12;
                CP_uK.h = new Integer[20];
                CP_uK.CP_a = (int)CP_uK.b("d", (int)7000, (long)(var22 ^ 9051843927667589360L));
                CP_uK.CP_m = (int)CP_uK.b("d", (int)8893, (long)(var22 ^ 8284384123770566930L));
                CP_uK.CP_G = (int)CP_uK.b("d", (int)20349, (long)(var22 ^ 3572903089303688408L));
                CP_uK.CP_F = (int)CP_uK.b("d", (int)8893, (long)(var22 ^ 8284384123770566930L));
                CP_uK.CP_f = (int)CP_uK.b("d", (int)20349, (long)(var22 ^ 3572903089303688408L));
                CP_uK.l = new HashMap<K, V>(13);
...
lbl131:
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_uK", exception);
            }
            ...
            CP_uK.e[n2] = CP_uK.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_uK" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])CP_uK.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    CP_uK.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_uK.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_uK.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(CP_uK.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
