...
@CP_jl(CP_J="Invalid Creative Slot", CP_M="Checks for invalid creative slot packets")
public class CP_ur
extends CP_uV {
    ...
    public CP_TV CP_h(PacketReceiveEvent packetReceiveEvent) {
        ...
        block9: {
            ...
            block7: {
                block8: {
                    ...
                    if (((Player)ilIloL).getGameMode() != GameMode.CREATIVE) {
                        return new CP_TE(this, (String)((Object)CP_ur.a("o", (int)1102, (long)(0x32B3E2D630F59703L ^ l))));
                    }
                    CP_JZ ilIlJZ = new CP_JZ(packetReceiveEvent);
                    n2 = n = ilIlJZ.CP_q();
                    object = CP_ur.b("c", (int)24987, (long)(0x2939BE70828A8E16L ^ l));
                    if (string != null) break block7;
                    if (n2 < object) break block8;
                    n2 = n;
                    object = CP_ur.b("c", (int)21405, (long)(0x6E9E701E0E7FBC13L ^ l));
                    if (string != null) break block7;
            ...
            if (string == null) {
                ...
                n2 = n;
                object = CP_ur.b("c", (int)24709, (long)(0xBA84EE6EE4F0F0AL ^ l));
            }
            if (n2 == object) return null;
        }
        CP_TV ilIlTV = new CP_TV(this, (String)((Object)CP_ur.a("o", (int)7443, (long)(0x70861122BF970E5FL ^ l))) + n);
        return ilIlTV;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_ur.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_ur", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            CP_ur.e[n2] = CP_ur.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_ur" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_ur.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_ur.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
