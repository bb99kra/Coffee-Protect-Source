...
@IlIljl(IlIlJ="Invalid Custom Payload", IlIlM="Checks for invalid custom payload packets")
public class IlIluK
extends IlIluV {
    private float IlIlA = 0.0f;
    private long IlIlB = 0L;
    private static final int IlIlG;
    private static final int IlIlf;
    private static final int IlIlF;
    private static final int IlIlm;
    private static final int IlIla;
    ...
    public IlIluK(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_CUSTOM_PAYLOAD_ENABLED.IlIlt());
    }

    private static double IlIlZ(long l, Location location) {
        return NumberConversions.square((double)((double)IlIluK.IlIlE(l) - location.getX())) + NumberConversions.square((double)((double)IlIluK.IlIlH(l) - location.getY())) + NumberConversions.square((double)((double)IlIluK.IlIlY(l) - location.getZ()));
    }

    private static int IlIlE(long l) {
        long l2 = b ^ 0x48A6FF8B7AABL;
        return (int)(l << 0 >> IlIluK.b("d", (int)30883, (long)(0x6E66A7B700E6A6FDL ^ l2)));
    }

    private static int IlIlH(long l) {
        long l2 = b ^ 0xCC31BB343A4L;
        return (int)(l << IlIluK.b("d", (int)17279, (long)(0x470E6F1CD1F52433L ^ l2)) >> IlIluK.b("d", (int)13466, (long)(0x109234A5AB8453DFL ^ l2)));
    }

    private static int IlIlY(long l) {
        long l2 = b ^ 0x1B41C73E5866L;
        return (int)(l << IlIluK.b("d", (int)29811, (long)(0x671E882E59BF88FCL ^ l2)) >> IlIluK.b("d", (int)27371, (long)(0x2E18334602E1679L ^ l2)));
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                IlIluK.b = IlIls.a((long)3333490147535127281L, (long)-353102473853109420L, MethodHandles.lookup().lookupClass()).a(28682455317985L);
                                IlIluK.f = new HashMap<K, V>(13);
                                var22 = IlIluK.b ^ 86440510685007L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = IlIluK.b(var32_9).intern();
...
lbl51:
                        ...
                        IlIluK.d = var31_3;
                        IlIluK.e = new String[40];
                        IlIluK.i = new HashMap<K, V>(13);
...
lbl104:
                ...
                IlIluK.g = var17_12;
                IlIluK.h = new Integer[20];
                IlIluK.IlIla = (int)IlIluK.b("d", (int)7000, (long)(var22 ^ 9051843927667589360L));
                IlIluK.IlIlm = (int)IlIluK.b("d", (int)8893, (long)(var22 ^ 8284384123770566930L));
                IlIluK.IlIlG = (int)IlIluK.b("d", (int)20349, (long)(var22 ^ 3572903089303688408L));
                IlIluK.IlIlF = (int)IlIluK.b("d", (int)8893, (long)(var22 ^ 8284384123770566930L));
                IlIluK.IlIlf = (int)IlIluK.b("d", (int)20349, (long)(var22 ^ 3572903089303688408L));
                IlIluK.l = new HashMap<K, V>(13);
...
lbl131:
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])IlIluK.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    IlIluK.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIluK.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(IlIluK.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
