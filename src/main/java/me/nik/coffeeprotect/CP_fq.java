...
implements CP_j9 {
    ...
    public static void CP_C(String[] stringArray) {
        CP_n = stringArray;
    }

    public static String[] CP_B() {
        return CP_n;
    }
     ...
     */
    static {
        a = CP_s.a(5810516659696142168L, 1122091443017373828L, MethodHandles.lookup().lookupClass()).a(59442233694722L);
