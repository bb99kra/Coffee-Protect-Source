...
@CP_jl(CP_J="Invalid Interact", CP_M="Checks for invalid interact packets")
public class CP_uf
extends CP_uV {
    ...
    public CP_TV CP_h(PacketReceiveEvent packetReceiveEvent) {
        ...
        if (n < 0) {
            return new CP_TE(this, (String)((Object)CP_uf.a("s", (int)21809, (long)(0x755858BC98A97581L ^ l))));
        }
        ...
        if (string == null) {
            if (gameMode != GameMode.SPECTATOR && n == packetReceiveEvent.getUser().CP_w()) {
                return new CP_TV(this, (String)((Object)CP_uf.a("s", (int)32605, (long)(0x47BCFE06C3DDFECL ^ l))));
            }
        ...
        if (CP_yR.CP_j(n) || ilIlQG != null && CP_yR.CP_M(ilIlQG.CP_Y(), ilIlQG.CP_g(), ilIlQG.CP_u())) {
            return new CP_TV(this, (String)((Object)CP_uf.a("s", (int)6979, (long)(0x49B7B3A2FD1C3BF0L ^ l))));
        }
        return null;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_uf.b(byArray3).intern();
            if ((n4 += n3) >= n2) {
                d = stringArray;
                e = new String[3];
                return;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_uf", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            CP_uf.e[n2] = CP_uf.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_uf" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_uf.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
