...
@CP_jl(CP_J="Invalid Position", CP_M="Checks for invalid position packets")
public class CP_u7
extends CP_uV {
    private CP_CU CP_O;
    private CP_iW CP_o;
        ...
        block23: {
            block22: {
                block24: {
                    block21: {
                        block20: {
                            CP_u7.b = CP_s.a(6907381331358088784L, 391193102449454204L, MethodHandles.lookup().lookupClass()).a(208580200663946L);
                            CP_u7.f = new HashMap<K, V>(13);
                            CP_u7.CP_p(null);
                            var16 = CP_u7.b ^ 3592274033359L;
...
lbl26:
                            ...
                            while (true) {
                                var25_3[var23_4++] = CP_u7.b(var26_9).intern();
...
lbl66:
                ...
                ** while (true)
                CP_u7.g = ((long)var15_13[0] & 255L) << 56 | ((long)var15_13[1] & 255L) << 48 | ((long)var15_13[2] & 255L) << 40 | ((long)var15_13[3] & 255L) << 32 | ((long)var15_13[4] & 255L) << 24 | ((long)var15_13[5] & 255L) << 16 | ((long)var15_13[6] & 255L) << 8 | (long)var15_13[7] & 255L;
                CP_u7.j = new HashMap<K, V>(13);
...
lbl126:
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_u7", exception);
            }
            ...
            CP_u7.e[n2] = CP_u7.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_u7" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_u7.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_u7.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
