...
public class IlIlGT {
    private static final String[] IlIlB;
    private final CoffeeProtect IlIlu;
    private IlIlCb IlIlI;
    ...
    public IlIlGT(CoffeeProtect coffeeProtect) {
        this.IlIlu = coffeeProtect;
    }
     ...
     */
    public void IlIlm() {
        var1_1 = IlIlGT.a ^ 100106264974257L;
        var4_2 = new File(this.IlIlu.getDataFolder(), (String)IlIlGT.a("n", (int)31153, (long)(7628178799134938222L ^ var1_1)));
        IlIlGT.IlIlH = var4_2.exists();
        var3_3 = IlIlGT.IlIlh();
        v0 = IlIlGT.IlIlH;
        if (var3_3 != null) {
            v0 = v0 == false;
        ...
        var6_5 = var5_4 = v0;
        this.IlIlI = IlIlCb.IlIlm(this.IlIlu, var4_2);
        v1 = var5_4;
        if (var3_3 != null) {
            if (v1) {
                this.IlIlI.IlIlH(IlIlGT.IlIlB);
            }
            v1 = this.IlIlu.IlIlO().IlIln();
        }
        if (var3_3 == null) ** GOTO lbl31
        if (!v1) ** GOTO lbl-1000
        v1 = this.IlIlu.IlIlm().IlIlb();
        if (var3_3 != null) {
            ** if (v1) goto lbl-1000
lbl-1000:
            // 1 sources
...
lbl35:
    ...
    static /* synthetic */ boolean IlIlC() {
        return IlIlH;
    }
    ...
    static {
        block21: {
            block20: {
                block19: {
                    block18: {
                        IlIlGT.a = IlIls.a((long)-6834623080181349888L, (long)7679400200754157312L, MethodHandles.lookup().lookupClass()).a(211620608456031L);
                        var20 = IlIlGT.a ^ 109808953032523L;
                        IlIlGT.d = new HashMap<K, V>(13);
                        IlIlGT.IlIlq(new PacketWrapper[3]);
...
lbl26:
                        ...
                        while (true) {
                            var18_3[var16_4++] = IlIlGT.a(var19_9).intern();
...
lbl104:
        ...
        v15[0] = IlIlGT.a("n", (int)4431, (long)(7950429711095107688L ^ var20));
        v15[1] = IlIlGT.a("n", (int)7125, (long)(3095908888815311603L ^ var20));
        v15[2] = IlIlGT.a("n", (int)26834, (long)(8379216236439890422L ^ var20));
        v15[3] = IlIlGT.a("n", (int)9612, (long)(4064625319233004719L ^ var20));
        v15[4] = IlIlGT.a("n", (int)25930, (long)(6319161177117418602L ^ var20));
        v15[5] = IlIlGT.a("n", (int)9612, (long)(4064625319233004719L ^ var20));
        v15[(int)var0_12[3]] = IlIlGT.a("n", (int)25142, (long)(171573598899331860L ^ var20));
        v15[(int)var0_12[2]] = IlIlGT.a("n", (int)9612, (long)(4064625319233004719L ^ var20));
        v15[(int)var0_12[1]] = IlIlGT.a("n", (int)17335, (long)(567442962144936598L ^ var20));
        IlIlGT.IlIlB = v15;
    }
    ...
    public static PacketWrapper[] IlIlh() {
        return IlIlb;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlGT", exception);
            }
            ...
            IlIlGT.c[n2] = IlIlGT.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlGT" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlGT.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
