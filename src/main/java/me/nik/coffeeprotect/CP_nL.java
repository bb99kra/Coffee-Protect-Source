...
Filter {
    ...
    public CP_nL() {
        ...
        String[] stringArray = new String[CP_nL.b("d", (int)7284, (long)(0x593647EB2A2CA915L ^ l))];
        stringArray[0] = CP_nL.a("y", (int)27266, (long)(0x23A09902FED4982L ^ l));
        stringArray[1] = CP_nL.a("y", (int)32546, (long)(0x4A535AB45AA05C21L ^ l));
        stringArray[2] = CP_nL.a("y", (int)5126, (long)(0x78570B98C963370DL ^ l));
        stringArray[3] = CP_nL.a("y", (int)12225, (long)(0x2E4EE0DCBD70CD9L ^ l));
        stringArray[4] = CP_nL.a("y", (int)26997, (long)(0x7D352ABAC6CF4A7CL ^ l));
        stringArray[5] = CP_nL.a("y", (int)8876, (long)(0x75327DDADC0D81A3L ^ l));
        stringArray[CP_nL.b("d", (int)21091, (long)(0x290F9188F6CC6717L ^ l))] = CP_nL.a("y", (int)13035, (long)(0x50ECEC450B8A11EAL ^ l));
        stringArray[CP_nL.b("d", (int)14125, (long)(0x37D5E1D61098242L ^ l))] = CP_nL.a("y", (int)17545, (long)(0x30B86BFF20926796L ^ l));
        stringArray[CP_nL.b("d", (int)18407, (long)(0x6496CCC2A5DC7283L ^ l))] = CP_nL.a("y", (int)7822, (long)(0x4F9467555C793D8AL ^ l));
        stringArray[CP_nL.b("d", (int)16562, (long)(0x588707BB7F5E75C5L ^ l))] = CP_nL.a("y", (int)13869, (long)(0x6C1615C65C81533L ^ l));
        stringArray[CP_nL.b("d", (int)22482, (long)(0x17ACD425AA6462B2L ^ l))] = CP_nL.a("y", (int)9386, (long)(0x353EF824BE8307B6L ^ l));
        stringArray[CP_nL.b("d", (int)14109, (long)(0x74670560DD2B827FL ^ l))] = CP_nL.a("y", (int)23049, (long)(0x22CB78462E787913L ^ l));
        stringArray[CP_nL.b("d", (int)3056, (long)(0x29E57258DC6A3E96L ^ l))] = CP_nL.a("y", (int)18117, (long)(0x2A9F8E8B6B0D65C3L ^ l));
        stringArray[CP_nL.b("d", (int)5094, (long)(0x7706D5902C6C268CL ^ l))] = CP_nL.a("y", (int)20980, (long)(0x6C416C0F63DE72F6L ^ l));
        stringArray[CP_nL.b("d", (int)2203, (long)(0x3E4D1B47934E3DEDL ^ l))] = CP_nL.a("y", (int)10429, (long)(0x55EDF378DC3C8BBAL ^ l));
        stringArray[CP_nL.b("d", (int)27370, (long)(0x58E19AFB3D0F5F81L ^ l))] = CP_nL.a("y", (int)12415, (long)(0x6B6EC12C8AD49375L ^ l));
        stringArray[CP_nL.b("d", (int)26956, (long)(0x6C1B8F669A11DC25L ^ l))] = CP_nL.a("y", (int)18412, (long)(0x2A1A9FD06BF064FFL ^ l));
        stringArray[CP_nL.b("d", (int)7052, (long)(0x51A0552708122EE0L ^ l))] = CP_nL.a("y", (int)11019, (long)(0x6D15B8281C040806L ^ l));
        stringArray[CP_nL.b("d", (int)2241, (long)(0xE45D05A18C9BDAFL ^ l))] = CP_nL.a("y", (int)7670, (long)(0x6376F086EA5ABEEFL ^ l));
        stringArray[CP_nL.b("d", (int)12799, (long)(0x704706862BE9849CL ^ l))] = CP_nL.a("y", (int)22944, (long)(0x72FD80CB007BFAAEL ^ l));
        stringArray[CP_nL.b("d", (int)11390, (long)(0x1F1C21405EA61913L ^ l))] = CP_nL.a("y", (int)11157, (long)(0x5C0CDE9707698899L ^ l));
        stringArray[CP_nL.b("d", (int)10639, (long)(0x53EB9AF2EADC9CE7L ^ l))] = CP_nL.a("y", (int)31100, (long)(0x24A3BBA24475DA74L ^ l));
        stringArray[CP_nL.b("d", (int)26795, (long)(0x799995970A67DDCCL ^ l))] = CP_nL.a("y", (int)11347, (long)(0x2A6A564EB7768F56L ^ l));
        stringArray[CP_nL.b("d", (int)27513, (long)(0x2FED7D2CDE1B5E1CL ^ l))] = CP_nL.a("y", (int)3749, (long)(0xEB3C19EB43F2DB8L ^ l));
    ...
    public void initialize() {
        ...
        if (!bl && bl2) {
            bl2 = this.CP_e.add((String)((Object)CP_nL.a("y", (int)17379, (long)(0x31C301743BB9F0A9L ^ l))));
        }
    ...
    static {
        block21: {
            block20: {
                block19: {
                    block18: {
                        CP_nL.a = CP_s.a(6004411483553951133L, -6334509397176540848L, MethodHandles.lookup().lookupClass()).a(245492548466631L);
                        CP_nL.d = new HashMap<K, V>(13);
                        var11 = CP_nL.a ^ 124314898624054L;
...
lbl25:
                        ...
                        while (true) {
                            var20_3[var18_4++] = CP_nL.a(var21_9).intern();
...
lbl51:
                ...
                CP_nL.b = var20_3;
                CP_nL.c = new String[25];
                CP_nL.g = new HashMap<K, V>(13);
...
lbl104:
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_nL", exception);
            }
            ...
            CP_nL.c[n2] = CP_nL.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_nL" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_nL.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_nL.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
