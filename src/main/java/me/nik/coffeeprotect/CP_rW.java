...
public final class CP_rW {
    ...
    public static String CP_W(String string) {
        long l = a ^ 0x6DCE1453D278L;
        return ChatColor.translateAlternateColorCodes((char)b, (String)string);
    }

    public static String CP_z(String string) {
        return ChatColor.stripColor((String)CP_J.matcher(string).replaceAll(""));
    }
    ...
    public static void CP_U(String ... stringArray) {
        ...
        while (n2 < n) {
            ...
            if (string != null) {
                if (string2 != null) {
                    CoffeeProtect.CP_J().getLogger().info(string2);
                }
                ++n2;
            }
     ...
     */
    static {
        a = CP_s.a(-7842931353528495544L, 8637661245626815437L, MethodHandles.lookup().lookupClass()).a(195237996076079L);
        ...
        String string = CP_rW.a(byArray3).intern();
    ...
    public static void CP_a(String string) {
        CP_V = string;
    }
