...
public final class IlIlyR {
    private static final CharsetDecoder IlIlw;
    private static int[] IlIlP;
     ...
     */
    public static boolean IlIlr(String var0, int var1_1) {
        block14: {
            block17: {
                block18: {
                    block15: {
                        block16: {
                            var2_2 = IlIlyR.a ^ 25891685574192L;
                            var5_3 = var0.length();
                            var4_4 = IlIluV.IlIlQ();
                            v0 = Math.abs(var5_3);
                            if (var4_4 == null) {
                                ...
                                v0 = IlIlLi.IlIle(var0, (String)IlIlyR.a("f", (int)9855, (long)(4256878517085455911L ^ var2_2)));
                            }
                            if (var4_4 != null) break block15;
                            if (v0) break block16;
                            v1 = var0;
                            if (var4_4 != null) break block17;
                            if (!IlIlLi.IlIle(v1, (String)IlIlyR.a("f", (int)21328, (long)(427751167458456329L ^ var2_2)))) break block18;
                        }
                        v0 = 1;
                    }
                    return v0;
            ...
            var9_8 = IlIlyR.IlIlw.decode(var8_7, var7_6, true);
...
lbl45:
    ...
    public static boolean IlIlx(int n, String ... stringArray) {
        boolean bl;
        block4: {
            long l = a ^ 0x1B0407C47791L;
            String[] stringArray2 = stringArray;
            int n2 = stringArray2.length;
            PacketWrapper[] packetWrapperArray = IlIluV.IlIlQ();
            int n3 = 0;
            while (n3 < n2) {
                String string = stringArray2[n3];
                if (packetWrapperArray == null) {
                    bl = IlIlyR.IlIlr(string, n);
    ...
    public static boolean IlIlJ(double ... dArray) {
        boolean bl;
        block4: {
     ...
     */
    public static boolean IlIlj(double d) {
    ...
    public static boolean IlIlM(float ... fArray) {
        boolean bl;
        block5: {
        ...
        if (PacketWrapper.IlIlz() == null) {
            IlIluV.IlIlx(new PacketWrapper[2]);
        }
        return bl;
    }
     ...
     * Lifted jumps to return sites
     */
    public static boolean IlIlR(float f) {
    ...
    public static boolean IlIlq(int ... nArray) {
        boolean bl;
        block4: {
     ...
     * Lifted jumps to return sites
     */
    public static boolean IlIlj(int n) {
        long l = a ^ 0x3247DEBCC085L;
        PacketWrapper[] packetWrapperArray = IlIluV.IlIlQ();
        int n2 = n;
        if (packetWrapperArray != null) return n2 != 0;
        if (n2 == IlIlyR.b("w", (int)16753, (long)(0x41314D34C2185F50L ^ l))) return 1 != 0;
        n2 = n;
        if (packetWrapperArray != null) return n2 != 0;
        if (n2 != IlIlyR.b("w", (int)14401, (long)(0xF1EA79B65A62661L ^ l))) return 0 != 0;
        return 1 != 0;
    }
     ...
     */
    static {
        a = IlIls.a((long)-928813211365702424L, (long)1500986229593232037L, MethodHandles.lookup().lookupClass()).a(94105275883731L);
        d = new HashMap(13);
        ...
        while (true) {
            ...
            stringArray[n++] = IlIlyR.a(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        b = stringArray;
        ...
        e = lArray;
        f = new Integer[2];
        IlIlw = StandardCharsets.UTF_8.newDecoder();
    }

    public static void IlIld(int[] nArray) {
        IlIlP = nArray;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlyR", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIlyR.c[n2] = IlIlyR.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlyR" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlyR.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlyR.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
