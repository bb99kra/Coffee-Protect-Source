...
public class CP_TM {
    ...
    public CP_TV CP_e(PacketReceiveEvent packetReceiveEvent) {
        block6: {
            CP_oI ilIloI;
            String string;
            long l;
            ...
            if (f > f2 * (float)n) {
                ...
                CP_rW.CP_U((String)((Object)CP_TM.a("f", (int)10519, (long)(0x22E4BAC6379E7519L ^ l))) + player.getName() + (String)((Object)CP_TM.a("f", (int)4042, (long)(0x276C19FEF09CD3C7L ^ l))) + f + (String)((Object)CP_TM.a("f", (int)25568, (long)(0x1498CEF9E6FB3FECL ^ l))) + packetReceiveEvent.getPacketType().CP_f() + "]");
    ...
    static {
        block14: {
            block13: {
                block12: {
                    CP_TM.a = CP_s.a(2817480816040098864L, -6323277062824538867L, MethodHandles.lookup().lookupClass()).a(162872413571850L);
                    CP_TM.d = new HashMap<K, V>(13);
                    CP_TM.CP_k("z8VCIb");
                    var5 = CP_TM.a ^ 140204550062647L;
...
lbl26:
                    ...
                    while (true) {
                        var14_3[var12_4++] = CP_TM.a(var15_9).intern();
...
lbl66:
        ...
        ** while (true)
        CP_TM.e = ((long)var4_13[0] & 255L) << 56 | ((long)var4_13[1] & 255L) << 48 | ((long)var4_13[2] & 255L) << 40 | ((long)var4_13[3] & 255L) << 32 | ((long)var4_13[4] & 255L) << 24 | ((long)var4_13[5] & 255L) << 16 | ((long)var4_13[6] & 255L) << 8 | (long)var4_13[7] & 255L;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_TM", exception);
            }
            ...
            CP_TM.c[n2] = CP_TM.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_TM" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_TM.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
