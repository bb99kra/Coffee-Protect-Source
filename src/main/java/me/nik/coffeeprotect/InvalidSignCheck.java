...
@CheckInfo(CP_J="Invalid Sign", CP_M="Checks for invalid sign packets")
public class InvalidSignCheck
extends Check {
    ...
    public InvalidSignCheck(UserData ilIlTM) {
    ...
    public CheckResult CP_h(PacketReceiveEvent var1_1) {
        block13: {
            block12: {
                var2_2 = InvalidSignCheck.b ^ 60096206822510L;
        ...
        for (var9_8 = 0; var9_8 < var8_7; ++var9_8) {
            block14: {
                block15: {
                    ...
                    cfr_temp_0 = this.CP_w.CP_UnderScore() - InvalidSignCheck.g;
                    ...
                    if (v1 != false) {
                        ...
                        if (var4_3 == null) {
                            if (v1 != false) {
                                return new CheckResult(this, (String)InvalidSignCheck.a("n", (int)31358, (long)(2180340854342631395L ^ var2_2)));
                            } else {
                                ** GOTO lbl34
                            }
                        } else {
...
lbl33:
                ...
                v1 = (long)CP_Li.CP_z(var10_9.toLowerCase(), new String[]{InvalidSignCheck.a("n", (int)13739, (long)(7269851395098308661L ^ var2_2)), InvalidSignCheck.a("n", (int)16306, (long)(7870431326068767278L ^ var2_2))});
            }
            if (v1 == false) continue;
            return new CP_TE(this, (String)InvalidSignCheck.a("n", (int)27192, (long)(9072852971854278567L ^ var2_2)));
        }
        return null;
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    InvalidSignCheck.b = CP_s.a(-3571352175982438078L, -8739882020379759471L, MethodHandles.lookup().lookupClass()).a(130819544933410L);
                    InvalidSignCheck.f = new HashMap<K, V>(13);
                    var5 = InvalidSignCheck.b ^ 59273370344723L;
...
lbl25:
                    ...
                    while (true) {
                        var14_3[var12_4++] = InvalidSignCheck.b(var15_9).intern();
...
lbl51:
            ...
            InvalidSignCheck.d = var14_3;
            InvalidSignCheck.e = new String[4];
...
lbl65:
        ...
        ** while (true)
        InvalidSignCheck.g = ((long)var4_13[0] & 255L) << 56 | ((long)var4_13[1] & 255L) << 48 | ((long)var4_13[2] & 255L) << 40 | ((long)var4_13[3] & 255L) << 32 | ((long)var4_13[4] & 255L) << 24 | ((long)var4_13[5] & 255L) << 16 | ((long)var4_13[6] & 255L) << 8 | (long)var4_13[7] & 255L;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidSignCheck", exception);
            }
            ...
            InvalidSignCheck.e[n2] = InvalidSignCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidSignCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidSignCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidSignCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
