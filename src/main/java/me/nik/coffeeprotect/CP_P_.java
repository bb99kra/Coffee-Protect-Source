 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.event.CP_Pw
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.event.CP_dF
 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.CP_nN
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.CP_s
...
public class CP_P_
extends CP_Pw {
    private final CoffeeProtect CP_L;
    private long CP_q;
    ...
    public CP_P_(CoffeeProtect coffeeProtect) {
        super(CP_dF.LOWEST);
        this.CP_L = coffeeProtect;
    }
     ...
     */
    public void CP_P(PacketReceiveEvent var1_1) {
        block81: {
            block79: {
                block80: {
                    block78: {
                        block76: {
                            block77: {
                                block67: {
                                                        ...
                                                        block68: {
                                                            block86: {
                                                                block66: {
                                                                    block64: {
                                                                        block65: {
                                                                            block63: {
                                                                                block62: {
                                                                                    block82: {
                                                                                        var2_2 = CP_P_.a ^ 123699654080291L;
                                                                                        var4_3 = CP_vF.CP_o();
                                                                                        v0 /* !! */  = var1_1.getUser();
                                                                    ...
                                                                    v7 = CP_Oq.DISABLE_OFFLINE_PACKETS.CP_t();
                                    ...
                                    try {
                                        if (v11 != v14) {
                                            ...
                                            CP_rW.CP_U(new String[]{(String)CP_P_.a("c", (int)9342, (long)(7453868665410283248L ^ var2_2)) + var6_5.CP_f() + (String)CP_P_.a("c", (int)28864, (long)(9006227347726283331L ^ var2_2)) + var5_4.getName()});
                                            return;
                                        }
                                    }
                                    catch (Throwable v23) {
                                ...
                                var7_6 = this.CP_L.CP_F().CP_R(var5_4);
                                try {
                                    if (var7_6 == null) {
                                        return;
                                    }
                                ...
                                try {
                                    ...
                                    block75: {
                                        block74: {
                                            try {
                                                try {
                                                    v25 = CP_Oq.PREVENT_INVALID_PACKETS.CP_t();
                                                ...
                                                var1_1.setCancelled(true);
                                                CoffeeProtect.CP_K().disconnect(var5_4);
                                                v25 = 1;
                                            }
                                            catch (Throwable v27) {
                                                throw CP_P_.a(v27);
                                        ...
                                        v28 = new String[v25];
                                        v28[0] = (String)CP_P_.a("c", (int)16924, (long)(5697534633590685854L ^ var2_2)) + var5_4.getName() + (String)CP_P_.a("c", (int)15768, (long)(2730463953650712350L ^ var2_2));
                                        CP_rW.CP_U(v28);
                                        return;
                                    }
                ...
                v36 = new String[v33];
                v36[0] = "[" + var8_7.CP_A() + (String)CP_P_.a("c", (int)15299, (long)(4722932104665102662L ^ var2_2)) + var5_4.getName() + (String)CP_P_.a("c", (int)4648, (long)(2283150640539488423L ^ var2_2)) + var9_9;
                CP_rW.CP_U(v36);
            }
            try {
...
lbl225:
                ...
                CoffeeProtect.CP_K().flag(var5_4, var8_7.CP_A(), var8_7.CP_e(), var8_7.CP_z());
            }
            catch (Throwable v37) {
                throw CP_P_.a(v37);
            }
     ...
     */
    public void CP_b(PacketSendEvent var1_1) {
        /*
    ...
    static {
        block17: {
            block16: {
                block15: {
                    block14: {
                        CP_P_.a = CP_s.a((long)3083170895345910377L, (long)-4776263975489416880L, MethodHandles.lookup().lookupClass()).a(128277672854574L);
                        CP_P_.d = new HashMap<K, V>(13);
                        var10 = CP_P_.a ^ 52386147074515L;
...
lbl25:
                        ...
                        while (true) {
                            var19_3[var17_4++] = CP_P_.a(var20_9).intern();
...
lbl65:
            ...
            ** while (true)
            CP_P_.e = ((long)var9_13[0] & 255L) << 56 | ((long)var9_13[1] & 255L) << 48 | ((long)var9_13[2] & 255L) << 40 | ((long)var9_13[3] & 255L) << 32 | ((long)var9_13[4] & 255L) << 24 | ((long)var9_13[5] & 255L) << 16 | ((long)var9_13[6] & 255L) << 8 | (long)var9_13[7] & 255L;
...
lbl86:
        ...
        ** while (true)
        CP_P_.f = ((long)var4_17[0] & 255L) << 56 | ((long)var4_17[1] & 255L) << 48 | ((long)var4_17[2] & 255L) << 40 | ((long)var4_17[3] & 255L) << 32 | ((long)var4_17[4] & 255L) << 24 | ((long)var4_17[5] & 255L) << 16 | ((long)var4_17[6] & 255L) << 8 | (long)var4_17[7] & 255L;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_P_", exception);
            }
            ...
            CP_P_.c[n2] = CP_P_.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_P_" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_P_.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
