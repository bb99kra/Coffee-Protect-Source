...
@CP_jl(CP_J="Invalid Sequence", CP_M="Checks for invalid packet sequence")
public class CP_ug
extends CP_uV {
...
lbl20:
                    ...
                    if (v0 >= 0) break;
                    return new CP_TV(this, (String)CP_ug.a("v", (int)4655, (long)(1419282306457870538L ^ var2_2)));
                }
                case 2: {
                    if (new CP_bV(var1_1).CP_n() >= 0) break;
                    return new CP_TV(this, (String)CP_ug.a("v", (int)4991, (long)(2912087106841321883L ^ var2_2)));
                }
                case 3: {
                    if (new CP_b1(var1_1).CP_p() >= 0) break;
                    return new CP_TV(this, (String)CP_ug.a("v", (int)3492, (long)(5823596343906385730L ^ var2_2)));
                }
            }
        }
        return null;
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_ug.b(byArray3).intern();
            if ((n4 += n3) >= n2) {
                d = stringArray;
                e = new String[3];
                return;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_ug", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            CP_ug.e[n2] = CP_ug.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_ug" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_ug.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
