...
@CheckInfo(CP_J="Invalid Spectate", CP_M="Checks for invalid spectate packets")
public class InvalidSpectateCheck
extends Check {
    private static final long b = CP_s.a(945157817482135844L, -3394171564546458896L, MethodHandles.lookup().lookupClass()).a(56700329974101L);
    private static final String d;
    private static final long e;
    private static transient /* synthetic */ String keohIeDGay = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public InvalidSpectateCheck(UserData ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_SPECTATE_ENABLED.CP_t());
    }
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        block4: {
            ...
            block5: {
                ...
                if (packetReceiveEvent.getPacketType() != CP_nN.SPECTATE) break block4;
                ilIlTM = this.CP_w;
                if (string != null) break block5;
                if (ilIlTM.CP_G() <= e) break block4;
                ilIlTM = packetReceiveEvent.getPlayer();
            }
            if (((Player)ilIlTM).getGameMode() != GameMode.SPECTATOR) {
    ...
    static {
        ...
        d = InvalidSpectateCheck.b(byArray3).intern();
