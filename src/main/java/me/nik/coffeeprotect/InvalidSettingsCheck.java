...
@CheckInfo(CP_J="Invalid Settings", CP_M="Checks for invalid settings packets")
public class InvalidSettingsCheck
extends Check {
    ...
    public InvalidSettingsCheck(UserData ilIlTM) {
    ...
    public CheckResult CP_h(PacketReceiveEvent packetReceiveEvent) {
        block12: {
                ...
                block16: {
                    block17: {
                        ...
                        block15: {
                            ...
                            return new CheckResult(this, (String)((Object)InvalidSettingsCheck.a("e", (int)3397, (long)(0x1D6EA5FF3E506C8FL ^ l))));
                        }
                        int n3 = CP_yR.CP_r(string, (int)g);
                        if (string2 == null) {
                            if (n3 != 0) {
                                return new CheckResult(this, (String)((Object)InvalidSettingsCheck.a("e", (int)23038, (long)(0x1FFD8E8360613835L ^ l))));
                            }
                            n3 = CP_u.matcher(string).matches();
                        }
                        if (string2 == null) {
                            if (n3 != 0) {
                                return new CheckResult(this, (String)((Object)InvalidSettingsCheck.a("e", (int)21855, (long)(0x7C53F9065D933493L ^ l))));
                            }
                            n3 = ilIlvP.CP_H();
                        }
                        n2 = n = n3;
            ...
            return new CheckResult(this, (String)((Object)InvalidSettingsCheck.a("e", (int)8650, (long)(0x4B8C1F826BFE4003L ^ l))) + n);
        }
        return null;
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    InvalidSettingsCheck.b = CP_s.a(3100142948036532319L, -3666744445023281680L, MethodHandles.lookup().lookupClass()).a(137510928854740L);
                    var14 = InvalidSettingsCheck.b ^ 92243842528050L;
                    InvalidSettingsCheck.f = new HashMap<K, V>(13);
...
lbl25:
                    ...
                    while (true) {
                        var12_3[var10_4++] = InvalidSettingsCheck.b(var13_9).intern();
...
lbl51:
            ...
            InvalidSettingsCheck.d = var12_3;
            InvalidSettingsCheck.e = new String[5];
...
lbl65:
        ...
        ** while (true)
        InvalidSettingsCheck.g = ((long)var4_13[0] & 255L) << 56 | ((long)var4_13[1] & 255L) << 48 | ((long)var4_13[2] & 255L) << 40 | ((long)var4_13[3] & 255L) << 32 | ((long)var4_13[4] & 255L) << 24 | ((long)var4_13[5] & 255L) << 16 | ((long)var4_13[6] & 255L) << 8 | (long)var4_13[7] & 255L;
        InvalidSettingsCheck.CP_u = Pattern.compile((String)InvalidSettingsCheck.a("e", (int)11444, (long)(1143483078162644262L ^ var14)));
    }
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidSettingsCheck", exception);
            }
            ...
            InvalidSettingsCheck.e[n2] = InvalidSettingsCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidSettingsCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidSettingsCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidSettingsCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
