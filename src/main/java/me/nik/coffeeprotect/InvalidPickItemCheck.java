...
@CheckInfo(CP_J="Invalid Pick Item", CP_M="Checks for invalid pick item packets")
public class InvalidPickItemCheck
extends Check {
    ...
    public InvalidPickItemCheck(UserData ilIlTM) {
    ...
    static {
        ...
        while (true) {
            if (n >= 8) {
                ...
                d = InvalidPickItemCheck.b(byArray3).intern();
                return;
            }
            byArray2 = byArray2;
