...
@CP_jl(CP_J="Invalid Chat", CP_M="Checks for invalid chat messages")
public class CP_uk
extends CP_uV {
    ...
    public CP_TV CP_h(PacketReceiveEvent var1_1) {
        block14: {
            var2_2 = CP_uk.b ^ 43379544535863L;
            var4_3 = CP_u7.CP_q();
...
lbl20:
                ...
                return new CP_TV(this, (String)CP_uk.a("q", (int)16548, (long)(3270387403059452439L ^ var2_2)));
lbl21:
                // 1 sources
...
lbl28:
                ...
                return new CP_TE(this, (String)CP_uk.a("q", (int)12453, (long)(8798337534403291676L ^ var2_2)));
lbl29:
                // 1 sources
...
lbl30:
                ...
                if (v4) {
                    return new CP_TV(this, (String)CP_uk.a("q", (int)13135, (long)(9072897529286797811L ^ var2_2)));
                }
                var8_7 = CP_uk.CP_F;
                ...
                while (var10_9 < var9_8) {
                    ...
                    if (var4_3 == null) {
                        if (CP_Li.CP_e(var7_6, var11_10)) {
                            return new CP_TE(this, (String)CP_uk.a("q", (int)19621, (long)(7888020855907767838L ^ var2_2)));
                        }
                        ++var10_9;
                    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    CP_uk.b = CP_s.a(1113241123413954243L, 8114955485592052489L, MethodHandles.lookup().lookupClass()).a(35326539531034L);
                    var16 = CP_uk.b ^ 137644411651157L;
...
lbl25:
                    ...
                    while (true) {
                        var14_3[var12_4++] = CP_uk.b(var15_9).intern();
...
lbl65:
        ...
        ** while (true)
        ...
        v10[0] = CP_uk.a("q", (int)22113, (long)(8713023470242462651L ^ var16));
        v10[1] = CP_uk.a("q", (int)32296, (long)(1413368308120638452L ^ var16));
        v10[2] = CP_uk.a("q", (int)28681, (long)(5107434098415492561L ^ var16));
        v10[3] = CP_uk.a("q", (int)24555, (long)(476146302875103798L ^ var16));
        v10[4] = CP_uk.a("q", (int)21810, (long)(5137102479431596269L ^ var16));
        v10[5] = "\u00bf";
        CP_uk.CP_F = v10;
    }
