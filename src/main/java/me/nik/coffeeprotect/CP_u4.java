...
@CP_jl(CP_J="Invalid Recipe", CP_M="Checks for invalid recipe packets")
public class CP_u4
extends CP_uV {
    private long CP_V;
    private long CP_z;
        ...
        block18: {
            ...
            block19: {
                block17: {
                        ...
                        block15: {
                            ...
                            block11: {
                                block12: {
                                    ...
                                    CP_TV ilIlTV = new CP_TV(this, (String)((Object)CP_u4.a("c", (int)9680, (long)(0x1EAF48972E5E1049L ^ l4))) + n);
                                    return ilIlTV;
                                }
                    ...
                    if (l3 > 0) {
                        return new CP_TE(this, (String)((Object)CP_u4.a("c", (int)8704, (long)(0x4251ABFC4C3D9798L ^ l4))));
                    }
                    break block19;
                }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_u4.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_u4", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            CP_u4.e[n2] = CP_u4.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_u4" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_u4.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
