...
@IlIljl(IlIlJ="Invalid Abilities", IlIlM="Checks for invalid abilities packets")
public class IlIluE
extends IlIluV {
    private static final long b = IlIls.a((long)-8003158481236764700L, (long)4972450649098962349L, MethodHandles.lookup().lookupClass()).a(7476736781404L);
    private static final String d;
    private static final long e;
    private static transient /* synthetic */ String hioehdlRCt = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public IlIluE(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_ABILITIES_ENABLED.IlIlt());
    }
    ...
    public IlIlTV IlIlh(PacketReceiveEvent packetReceiveEvent) {
        block4: {
            ...
            block5: {
                ...
                if (packetReceiveEvent.getPacketType() != IlIlnN.PLAYER_ABILITIES) break block4;
                long l3 = this.IlIlw.IlIlG() - e;
                l = l3 == 0L ? 0 : (l3 < 0L ? -1 : 1);
