...
@CP_jl(CP_J="Invalid Select Bundle Item", CP_M="Checks for invalid select bundle item packets")
public class CP_uB
extends CP_uV {
    ...
    public CP_TV CP_h(PacketReceiveEvent packetReceiveEvent) {
        block13: {
            ...
            block14: {
                        ...
                        block11: {
                            ...
                            block8: {
                                ...
                                block9: {
                                    ...
                                    if (n <= CP_uB.b("s", (int)15763, (long)(0x6B395CEEA1B5A559L ^ l))) break block11;
                                }
                                ilIlbb.CP_F(-1);
                                packetReceiveEvent.markForReEncode(true);
                            }
                            return new CP_TV(this, (String)((Object)CP_uB.a("d", (int)12475, (long)(0x44A097A3C70F820AL ^ l))) + n3);
                        }
                        n = n2;
                    }
                ...
                object = CP_uB.b("s", (int)1851, (long)(0x6205431AB1909FF0L ^ l));
            ...
            if (n != object) {
                return new CP_TV(this, (String)((Object)CP_uB.a("d", (int)18608, (long)(0x36C1E18681BA7A00L ^ l))) + n2);
            }
        }
        return null;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_uB.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
