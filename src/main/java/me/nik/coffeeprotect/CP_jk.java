...
extends CP_ju {
    ...
    private static final long a = CP_s.a(565229063273202640L, -8476492630298569552L, MethodHandles.lookup().lookupClass()).a(192272654946962L);
    ...
    protected String CP_C() {
        ...
        return CP_jk.a("j", (int)3637, (long)(0x4BC4734E1B027825L ^ l));
    }

    @Override
    protected String CP_V() {
        long l = a ^ 0x3A533702A6D6L;
        return CP_jk.a("j", (int)10380, (long)(0x79D59B10CFD38404L ^ l));
    }

    @Override
    protected String CP_d() {
        long l = a ^ 0x100400022106L;
        return CP_jk.a("j", (int)16624, (long)(0x68F0AB4DCD6FEBAAL ^ l));
    }

    @Override
    protected String CP_a() {
        return CP_x5.ALERTS.CP_a();
    }
        ...
        block6: {
            ...
            block4: {
                block5: {
                    ...
                    bl = CP_jf.CP_J();
                    ilIliZ = this.CP_x.CP_c();
                    if (bl) break block4;
                    if (!ilIliZ.CP_F().contains(uUID)) break block5;
                    this.CP_x.CP_c().CP_B(uUID);
                    commandSender.sendMessage(CP_xi.ALERTS_DISABLED.CP_F());
                    if (!bl) break block6;
                }
                ilIliZ = this.CP_x.CP_c();
            }
            ilIliZ.CP_S(uUID);
            commandSender.sendMessage(CP_xi.ALERTS_ENABLED.CP_F());
        }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_jk.a(byArray3).intern();
            if ((n4 += n3) >= n2) {
                b = stringArray;
                c = new String[3];
                return;
