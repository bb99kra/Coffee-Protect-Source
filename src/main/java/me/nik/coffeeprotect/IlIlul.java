 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlbC
...
@IlIljl(IlIlJ="Invalid Tab Complete", IlIlM="Checks for invalid tab complete packets")
public class IlIlul
extends IlIluV {
    private static final String IlIlD;
    ...
    public IlIlul(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_TAB_COMPLETE_ENABLED.IlIlt());
    }
                    ...
                    block20: {
                        ...
                        block22: {
                            ...
                            block21: {
                                        ...
                                        block18: {
                                            block16: {
                                                ...
                                                block15: {
                                                    ...
                                                    if (packetReceiveEvent.getPacketType() != IlIlnN.TAB_COMPLETE) {
                                                        return null;
                                                    }
                                                    string3 = string = new IlIlbC(packetReceiveEvent).IlIlA();
                                            ...
                                            return new IlIlTV(this, (String)((Object)IlIlul.a("e", (int)30988, (long)(0x2F6C0942466783B5L ^ l))));
                                        }
                                        n5 = IlIlyR.IlIlr(string, IlIlOq.CHECKS_INVALID_TAB_COMPLETE_MAX_INPUT_LENGTH.IlIlj());
                                    }
                                    if (string2 == null) {
                                        if (n5 != 0) {
                                            return new IlIlTV(this, (String)((Object)IlIlul.a("e", (int)23104, (long)(0x38032C8E995E20FFL ^ l))));
                                        }
                                        n5 = string.length();
                                    }
                                    n3 = n4 = n5;
                                    if (string2 != null) break block19;
                                    if (n3 <= IlIlul.b("f", (int)28340, (long)(0xBE9A5BCB52BCFAAL ^ l))) break block20;
                                    n3 = string.indexOf((int)IlIlul.b("f", (int)29994, (long)(0x2967A7D225FE5435L ^ l)));
                                }
                                n = n2 = n3;
                                object = -1;
                                ...
                                object = IlIlul.b("f", (int)1892, (long)(0x23E30056CD702678L ^ l));
                            }
                            if (n < object) break block20;
                        }
                        return new IlIlTV(this, (String)((Object)IlIlul.a("e", (int)11075, (long)(0x21BAD2C6FEA351FBL ^ l))) + n2);
                    }
                    n = string.contains((CharSequence)((Object)IlIlul.a("e", (int)15761, (long)(0x5DCB12266806472BL ^ l)))) ? 1 : 0;
                }
                if (string2 == null) {
                    if (n != 0) {
                        return new IlIlTV(this, (String)((Object)IlIlul.a("e", (int)17652, (long)(0x40A3E2D5C0F43E4AL ^ l))));
                    }
                    n = IlIlOq.CHECKS_INVALID_TAB_COMPLETE_PREVENT_PLUGINS_EXPLOIT.IlIlt() ? 1 : 0;
                }
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        IlIlul.b = IlIls.a((long)4761892485002738623L, (long)-268307710394434212L, MethodHandles.lookup().lookupClass()).a(51067309914684L);
                        IlIlul.f = new HashMap<K, V>(13);
                        var11 = IlIlul.b ^ 123879360880083L;
...
lbl25:
                        ...
                        while (true) {
                            var20_3[var18_4++] = IlIlul.b(var21_9).intern();
...
lbl51:
                ...
                IlIlul.d = var20_3;
                IlIlul.e = new String[6];
                IlIlul.IlIlD = IlIlul.a("e", (int)12434, (long)(1069890352156784834L ^ var11));
                IlIlul.i = new HashMap<K, V>(13);
...
lbl74:
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlul.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
