 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIlPn
 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.event.simple.PacketPlayReceiveEvent
 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlJZ
...
import me.nik.coffeeprotect.IlIlQ3;
...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIlPn;
...
extends IlIlPn
implements IlIljR {
    private final ExecutorService IlIl_;
    private final File IlIlq;
    ...
    public IlIlP1(CoffeeProtect coffeeProtect) {
        long l = b ^ 0x59C5860083ECL;
        String string = IlIlnH.IlIlH();
        super(IlIldF.MONITOR);
        String string2 = string;
        try {
            this.IlIl_ = Executors.newSingleThreadExecutor();
            this.IlIlo = false;
            this.IlIlq = new File(coffeeProtect.getDataFolder(), (String)((Object)IlIlP1.a("k", (int)24394, (long)(0x4FD27AFCFCC66ED9L ^ l))));
            if (string2 == null) {
                PacketWrapper.IlIle((int[])new int[3]);
            }
        }
        catch (IlIlfF ilIlfF) {
            throw IlIlP1.a(ilIlfF);
        }
    }

    private IlIlCg IlIlW(PacketReceiveEvent packetReceiveEvent) {
        IlIlCg ilIlCg;
        block12: {
            IlIlCg ilIlCg2;
            block10: {
                ...
                block11: {
                    ...
                    ilIlCg3 = null;
                    String string = IlIlnH.IlIlH();
                    switch (IlIlQ3.IlIlA[((IlIlnN)packetReceiveEvent.getPacketType()).ordinal()]) {
                        case 1: {
                            ilIlCg3 = new IlIlJZ(packetReceiveEvent).IlIlM();
                            break;
                        }
                        case 2: {
                            ilIlCg3 = new IlIlJ2(packetReceiveEvent).IlIln();
                            break;
                        }
                        case 3: {
                            ilIlCg3 = new IlIlb5(packetReceiveEvent).IlIlm().orElse(null);
                            break;
                        }
                        case 4: {
                            ilIlCg3 = new IlIlJv(packetReceiveEvent).IlIlH();
                        }
                    }
                    try {
                        try {
     ...
     */
    public void IlIlO(PacketPlayReceiveEvent var1_1) {
        block26: {
            block24: {
                block25: {
                    block23: {
                        block22: {
                            var2_2 = IlIlP1.b ^ 6600243595990L;
                            var4_3 = IlIlnH.IlIlH();
                            try {
                                try {
                                    try {
...
lbl39:
            ...
            try {
                v8 = IlIlQ3.IlIlA[var5_4.ordinal()];
...
lbl55:
        ...
        var8_7 = this.IlIlW((PacketReceiveEvent)var1_1);
        this.IlIl_.execute((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$onPacketPlayReceive$1(org.bukkit.entity.Player me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.IlIlnN int me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.item.IlIlCg ), ()V)((IlIlP1)this, (Player)var7_6, (IlIlnN)var5_4, (int)var6_5, (IlIlCg)var8_7));
    }
            ...
            block5: {
                ...
                try {
                    try {
                        ...
                        if (!ilIlP1.IlIlo) break block5;
                    }
                    catch (IlIlfF ilIlfF) {
                        throw IlIlP1.a(ilIlfF);
                    }
                    return IlIlnH.ALREADY_RUNNING;
                }
                catch (IlIlfF ilIlfF) {
                    throw IlIlP1.a(ilIlfF);
                }
     ...
     * Loose catch block
     */
    private /* synthetic */ void lambda$onPacketPlayReceive$1(Player player, IlIlnN ilIlnN, int n, IlIlCg ilIlCg) {
        block21: {
            Object object;
            Object object2;
                        ...
                        block27: {
                            block25: {
                                block26: {
                                        ...
                                        block23: {
                                            ...
                                            block20: {
                                                ...
                                                try {
                                                    ...
                                                    throw IlIlP1.a(iOException);
                                                }
                                                player2 = player;
                                            }
                                            if (!player2.isOnline()) break block21;
                                            stringBuilder = new StringBuilder((String)((Object)IlIlP1.a("k", (int)11972, (long)(0x3D2D8DC583C43E80L ^ l))) + player.getName() + (String)((Object)IlIlP1.a("k", (int)18651, (long)(0x6D3997CAA17B589EL ^ l))) + ilIlnN.name() + (String)((Object)IlIlP1.a("k", (int)1244, (long)(0x6C3375FAFFFB149DL ^ l))) + n);
                                            try {
                                                ilIlCg2 = ilIlCg;
                                    ...
                                    object2 = ilIlCg2.IlIlJ().getName().getKey();
                                    if (string2 == null) break block25;
                                    try {
                                        if (!((String)object2).equals(IlIlP1.a("k", (int)31400, (long)(0x4AAFB7BA06B8EAEBL ^ l)))) break block26;
                                        break block24;
                                        catch (IOException iOException) {
                                            throw IlIlP1.a(iOException);
                                        }
                                ...
                                stringBuilder.append((String)((Object)IlIlP1.a("k", (int)167, (long)(0x5FD55BEACE2310E7L ^ l)))).append((String)object2);
                            }
                            object = ilIlCg.IlIlL();
                            try {
                                nBTCompound = object;
            ...
            try {
                block29: {
                    ...
                    try {
                        ...
                        bl = this.IlIlq.createNewFile();
                    }
                    catch (IOException iOException) {
                        throw IlIlP1.a(iOException);
                    }
                }
                object2 = new FileWriter(this.IlIlq, true);
                ...
                this.IlIlq();
                throw new IlIlfF((String)((Object)IlIlP1.a("k", (int)24420, (long)(0x12AB18A8CABA4F23L ^ l))) + iOException.getLocalizedMessage());
            }
        }
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    IlIlP1.b = IlIls.a((long)-8197292846402025959L, (long)-4431068857028150244L, MethodHandles.lookup().lookupClass()).a(23319460801725L);
                    IlIlP1.e = new HashMap<K, V>(13);
                    var5 = IlIlP1.b ^ 73957463818070L;
...
lbl25:
                    ...
                    while (true) {
                        var14_3[var12_4++] = IlIlP1.a(var15_9).intern();
...
lbl65:
        ...
        ** while (true)
        IlIlP1.f = ((long)var4_13[0] & 255L) << 56 | ((long)var4_13[1] & 255L) << 48 | ((long)var4_13[2] & 255L) << 40 | ((long)var4_13[3] & 255L) << 32 | ((long)var4_13[4] & 255L) << 24 | ((long)var4_13[5] & 255L) << 16 | ((long)var4_13[6] & 255L) << 8 | (long)var4_13[7] & 255L;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (d[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlP1", exception);
            }
            ...
            IlIlP1.d[n2] = IlIlP1.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return d[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlP1" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlP1.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
