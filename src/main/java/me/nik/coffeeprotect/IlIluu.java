...
@IlIljl(IlIlJ="Invalid Block Placement", IlIlM="Checks for invalid block placements")
public class IlIluu
extends IlIluV {
    private long IlIlY;
    private long IlIlM;
    ...
    public IlIluu(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_BLOCK_PLACEMENT_ENABLED.IlIlt());
    }
            ...
            block20: {
                block19: {
                    block18: {
                        block17: {
                            block16: {
                                IlIluu.b = IlIls.a((long)3548400658391628368L, (long)2178758214804283373L, MethodHandles.lookup().lookupClass()).a(205999691178231L);
                                IlIluu.f = new HashMap<K, V>(13);
                                var22 = IlIluu.b ^ 3716381410889L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = IlIluu.b(var32_9).intern();
...
lbl51:
                        ...
                        IlIluu.d = var31_3;
                        IlIluu.e = new String[13];
                        IlIluu.i = new HashMap<K, V>(13);
...
lbl73:
                ...
                IlIluu.g = var17_12;
                IlIluu.h = new Integer[3];
                IlIluu.l = new HashMap<K, V>(13);
...
lbl107:
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIluu", exception);
            }
            ...
            IlIluu.e[n2] = IlIluu.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIluu" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])IlIluu.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    IlIluu.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIluu.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIluu.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(IlIluu.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
