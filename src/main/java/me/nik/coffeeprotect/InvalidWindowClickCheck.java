...
@CheckInfo(CP_J="Invalid Window Click", CP_M="Checks for invalid window click packets")
public class InvalidWindowClickCheck
extends Check {
    private long CP_A;
    private long CP_T;
    private int CP_v;
    ...
    public InvalidWindowClickCheck(UserData ilIlTM) {
    ...
    public CheckResult CP_h(PacketReceiveEvent var1_1) {
        var2_2 = InvalidWindowClickCheck.b ^ 39057855569527L;
        ...
        switch (v0 ? 1 : 0) {
            case 1: {
                ...
                cfr_temp_0 = var17_16 - InvalidWindowClickCheck.c("s", (int)13089, (long)(1136099952360849211L ^ var2_2));
                v2 = cfr_temp_0 == 0L ? 0 : (cfr_temp_0 < 0L ? -1 : 1);
                if (var4_3 != null) ** GOTO lbl36
                if (v2 < 0) {
                    v2 = (cfr_temp_1 = this.CP_T++ - InvalidWindowClickCheck.c("s", (int)11770, (long)(8259089055191491042L ^ var2_2))) == 0L ? 0 : (cfr_temp_1 < 0L ? -1 : 1);
lbl36:
                    // 2 sources

                    if (var4_3 == null) {
                        if (v2 > 0) {
                            return new CP_TE(this, (String)InvalidWindowClickCheck.a("a", (int)23776, (long)(6789722631331156772L ^ var2_2)));
                        }
                    ...
                    this.CP_T = Math.max(0L, this.CP_T / InvalidWindowClickCheck.c("s", (int)11918, (long)(876050492126257813L ^ var2_2)));
                }
                this.CP_A = var15_14;
lbl46:
                // 3 sources
...
lbl47:
                ...
                if (v1 != 0) {
                    return new CheckResult(this, (String)InvalidWindowClickCheck.a("a", (int)7444, (long)(4588932610785235665L ^ var2_2)));
                }
...
lbl56:
                ...
                return new CP_TE(this, (String)InvalidWindowClickCheck.a("a", (int)5311, (long)(2527359475348626294L ^ var2_2)) + var9_8 + (String)InvalidWindowClickCheck.a("a", (int)10006, (long)(4524218550054316249L ^ var2_2)) + var10_9);
lbl57:
                // 2 sources
...
lbl62:
                        ...
                        v4 = InvalidWindowClickCheck.b("n", (int)20855, (long)(232250825328876139L ^ var2_2));
                        if (var4_3 == null) {
                            if (v3 <= v4) {
                                v3 = var10_9;
                                if (var4_3 == null) {
                            ...
                            v4 = InvalidWindowClickCheck.b("n", (int)6212, (long)(3082694641636709213L ^ var2_2));
                        }
                        if (v3 == v4) break;
                        return new CP_TE(this, var8_7.name() + (String)InvalidWindowClickCheck.a("a", (int)23210, (long)(6018870529202296164L ^ var2_2)) + var10_9);
                    }
                    case 2: {
                        v5 = var9_8;
...
lbl82:
                        ...
                        return new CP_TE(this, var8_7.name() + (String)InvalidWindowClickCheck.a("a", (int)7143, (long)(6666087126636680237L ^ var2_2)) + var9_8 + (String)InvalidWindowClickCheck.a("a", (int)25591, (long)(3261280814880500791L ^ var2_2)) + var10_9);
                    }
                    case 3: 
                    case 4: 
                    case 5: {
...
lbl89:
                        ...
                        return new CP_TE(this, var8_7.name() + (String)InvalidWindowClickCheck.a("a", (int)17495, (long)(4943970990159661958L ^ var2_2)) + var10_9);
lbl90:
                        // 1 sources
                        ...
                        v7 = var9_8;
                        if (var4_3 == null) {
                            if (v7 == InvalidWindowClickCheck.b("n", (int)24616, (long)(4844559873671981872L ^ var2_2))) {
                                return new CP_TE(this, var8_7.name() + (String)InvalidWindowClickCheck.a("a", (int)8670, (long)(488860293831388691L ^ var2_2)) + var9_8);
                            }
                            v7 = var11_10;
                        }
                        if (var4_3 == null) {
                        ...
                        if (v7 >= 0) break;
                        return new CP_TE(this, var8_7.name() + (String)InvalidWindowClickCheck.a("a", (int)8670, (long)(488860293831388691L ^ var2_2)) + var9_8 + (String)InvalidWindowClickCheck.a("a", (int)21212, (long)(6646069215065251098L ^ var2_2)) + var11_10);
                    }
                    case 6: {
                        v8 = var10_9;
                        v9 /* !! */  = 3;
                        ...
                        v8 = var10_9;
                        v9 /* !! */  = (int)InvalidWindowClickCheck.b("n", (int)10502, (long)(5718335902053573148L ^ var2_2));
lbl108:
                        // 2 sources
                        ...
                        v9 /* !! */  = (int)InvalidWindowClickCheck.b("n", (int)29132, (long)(71834326352952023L ^ var2_2));
lbl113:
                        // 2 sources
...
lbl116:
                    ...
                    case 8: {
                        return new CP_TE(this, (String)InvalidWindowClickCheck.a("a", (int)17078, (long)(2332260837028400497L ^ var2_2)));
                    }
                }
                if (var7_6 == null) {
                    return new CP_TE(this, (String)InvalidWindowClickCheck.a("a", (int)31511, (long)(6683206169244218567L ^ var2_2)));
                }
                v10 = var9_8;
                if (var4_3 != null) ** GOTO lbl139
                if (v10 >= 0) ** GOTO lbl138
                v10 = var9_8;
                v11 /* !! */  = (int)InvalidWindowClickCheck.b("n", (int)868, (long)(4476357228298340474L ^ var2_2));
                ...
                if (v10 != v11 /* !! */ ) {
                    ...
                    if (var4_3 == null) {
                        if (v10 != v11 /* !! */ ) {
                            return new CheckResult(this, (String)InvalidWindowClickCheck.a("a", (int)9099, (long)(2266814881314925640L ^ var2_2)) + var9_8);
                        } else {
                            ** GOTO lbl138
                        }
                    } else {
...
lbl141:
                ...
                if (v10 < v11 /* !! */ ) {
                    return new CP_TE(this, (String)InvalidWindowClickCheck.a("a", (int)24034, (long)(6536844323664302638L ^ var2_2)) + var7_6.countSlots());
                }
...
lbl144:
                ...
                if (var4_3 == null) {
                    if (v10 == 0) break;
                    v10 = (int)var7_6.getTopInventory().getType().name().equalsIgnoreCase((String)InvalidWindowClickCheck.a("a", (int)1900, (long)(2504488736785123492L ^ var2_2)));
                }
                if (v10 == 0) break;
                return new CP_TE(this);
            }
...
lbl156:
                ...
                return new CheckResult(this, (String)InvalidWindowClickCheck.a("a", (int)5517, (long)(8824830662190127695L ^ var2_2)) + var15_15.CP_s() + (String)InvalidWindowClickCheck.a("a", (int)26761, (long)(1532232519581083458L ^ var2_2)) + var15_15.CP_g());
            }
            case 3: {
...
lbl163:
                ...
                v14 = InvalidWindowClickCheck.b("n", (int)19061, (long)(4117336834405941610L ^ var2_2));
                if (var4_3 == null) {
                    if (v13 <= v14) break;
                    v13 = var17_17;
                    v14 = InvalidWindowClickCheck.b("n", (int)30193, (long)(6525136363820220140L ^ var2_2));
                }
                if (v13 == v14) break;
lbl169:
                // 2 sources

                return new CheckResult(this, (String)InvalidWindowClickCheck.a("a", (int)3505, (long)(2795013596266480240L ^ var2_2)) + var17_17);
            }
        }
        return null;
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                InvalidWindowClickCheck.b = CP_s.a(-7994644512299029602L, 6067488787573586001L, MethodHandles.lookup().lookupClass()).a(8512756142942L);
                                InvalidWindowClickCheck.f = new HashMap<K, V>(13);
                                var22 = InvalidWindowClickCheck.b ^ 57365890296974L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = InvalidWindowClickCheck.b(var32_9).intern();
...
lbl51:
                        ...
                        InvalidWindowClickCheck.d = var31_3;
                        InvalidWindowClickCheck.e = new String[18];
                        InvalidWindowClickCheck.i = new HashMap<K, V>(13);
...
lbl104:
                ...
                InvalidWindowClickCheck.g = var17_12;
                InvalidWindowClickCheck.h = new Integer[8];
                InvalidWindowClickCheck.l = new HashMap<K, V>(13);
...
lbl126:
        ...
        InvalidWindowClickCheck.j = var6_22;
        InvalidWindowClickCheck.k = new Long[3];
    }
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidWindowClickCheck", exception);
            }
            ...
            InvalidWindowClickCheck.e[n2] = InvalidWindowClickCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidWindowClickCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidWindowClickCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static int b(int n, long l) {
        ...
        if (h[n2] == null) {
            ...
            InvalidWindowClickCheck.h[n2] = n3;
        }
        return h[n2];
    }
    ...
    private static int b(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        int n = (Integer)objectArray[0];
        long l = (Long)objectArray[1];
        int n2 = InvalidWindowClickCheck.b(n, l);
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])InvalidWindowClickCheck.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    InvalidWindowClickCheck.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
            ...
            InvalidWindowClickCheck.k[n2] = l4;
        }
        return k[n2];
    }
    ...
    private static long c(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        int n = (Integer)objectArray[0];
        long l = (Long)objectArray[1];
        long l2 = InvalidWindowClickCheck.c(n, l);
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidWindowClickCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(InvalidWindowClickCheck.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(InvalidWindowClickCheck.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
