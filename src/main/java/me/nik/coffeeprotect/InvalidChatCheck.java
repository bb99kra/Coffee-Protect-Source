...
import me.nik.coffeeprotect.CP_ik;
...
@CheckInfo(CP_J="Invalid Chat", CP_M="Checks for invalid chat messages")
public class InvalidChatCheck
extends Check {
    private static final String[] CP_F;
    ...
    public InvalidChatCheck(UserData ilIlTM) {
        super(ilIlTM, CP_Oq.CHECKS_INVALID_CHAT_ENABLED.CP_t());
    }

    private static void CP_i(PacketReceiveEvent packetReceiveEvent) {
        block2: {
            block3: {
                long l = b ^ 0x2C47AAFEE1C4L;
                String string = InvalidPositionCheck.CP_q();
                if (!CP_Oq.CHECKS_INVALID_CHAT_FIX_MESSAGES.CP_t() || packetReceiveEvent.getPacketType() != CP_nN.CHAT_MESSAGE) break block2;
                CP_Jh ilIlJh = new CP_Jh(packetReceiveEvent);
                String string2 = ilIlJh.CP_L();
                String string3 = CP_Li.CP_Q(ilIlJh.CP_L());
    ...
    public CheckResult CP_h(PacketReceiveEvent var1_1) {
        block14: {
            var2_2 = InvalidChatCheck.b ^ 43379544535863L;
            ...
            v0 = v1 /* !! */ [((CP_nN)var1_1.getPacketType()).ordinal()];
        }
...
lbl14:
                ...
                var5_4 /* !! */  = v1 /* !! */ ;
                v2 = var6_5 = ByteBufHelper.CP_b(var5_4 /* !! */ );
...
lbl19:
                ...
                if (v2 <= CP_Oq.CHECKS_INVALID_CHAT_MAX_INPUT_LENGTH.CP_j() * 4) ** GOTO lbl21
lbl20:
                // 2 sources

                return new CheckResult(this, (String)InvalidChatCheck.a("q", (int)16548, (long)(3270387403059452439L ^ var2_2)));
lbl21:
                // 1 sources

                v3 = var7_6 = ByteBufHelper.CP_t(var5_4 /* !! */ , ByteBufHelper.readerIndex(var5_4 /* !! */ ), var6_5, StandardCharsets.UTF_8);
...
lbl28:
                ...
                return new CP_TE(this, (String)InvalidChatCheck.a("q", (int)12453, (long)(8798337534403291676L ^ var2_2)));
lbl29:
                // 1 sources

                v4 = CP_yR.CP_r(var7_6, CP_Oq.CHECKS_INVALID_CHAT_MAX_INPUT_LENGTH.CP_j());
lbl30:
                // 2 sources

                if (v4) {
                    return new CheckResult(this, (String)InvalidChatCheck.a("q", (int)13135, (long)(9072897529286797811L ^ var2_2)));
                }
                var8_7 = InvalidChatCheck.CP_F;
                ...
                while (var10_9 < var9_8) {
                    ...
                    if (var4_3 == null) {
                        if (CP_Li.CP_e(var7_6, var11_10)) {
                            return new CP_TE(this, (String)InvalidChatCheck.a("q", (int)19621, (long)(7888020855907767838L ^ var2_2)));
                        }
                        ++var10_9;
                    }
                    if (var4_3 == null) continue;
                }
                InvalidChatCheck.CP_i(var1_1);
            }
        }
        return null;
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    InvalidChatCheck.b = CP_s.a(1113241123413954243L, 8114955485592052489L, MethodHandles.lookup().lookupClass()).a(35326539531034L);
                    var16 = InvalidChatCheck.b ^ 137644411651157L;
                    InvalidChatCheck.f = new HashMap<K, V>(13);
...
lbl25:
                    ...
                    while (true) {
                        var14_3[var12_4++] = InvalidChatCheck.b(var15_9).intern();
...
lbl51:
            ...
            InvalidChatCheck.d = var14_3;
            InvalidChatCheck.e = new String[9];
...
lbl65:
        ...
        ** while (true)
        ...
        v10[0] = InvalidChatCheck.a("q", (int)22113, (long)(8713023470242462651L ^ var16));
        v10[1] = InvalidChatCheck.a("q", (int)32296, (long)(1413368308120638452L ^ var16));
        v10[2] = InvalidChatCheck.a("q", (int)28681, (long)(5107434098415492561L ^ var16));
        v10[3] = InvalidChatCheck.a("q", (int)24555, (long)(476146302875103798L ^ var16));
        v10[4] = InvalidChatCheck.a("q", (int)21810, (long)(5137102479431596269L ^ var16));
        v10[5] = "\u00bf";
        InvalidChatCheck.CP_F = v10;
    }
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/InvalidChatCheck", exception);
            }
            ...
            InvalidChatCheck.e[n2] = InvalidChatCheck.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, Object[] objectArray) {
        ...
        String string2 = InvalidChatCheck.a(n, l);
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/InvalidChatCheck" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(InvalidChatCheck.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
