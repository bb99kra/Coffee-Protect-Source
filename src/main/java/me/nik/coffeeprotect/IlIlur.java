...
@IlIljl(IlIlJ="Invalid Creative Slot", IlIlM="Checks for invalid creative slot packets")
public class IlIlur
extends IlIluV {
    private static final long b = IlIls.a((long)2642267270536832029L, (long)-5395196143836573459L, MethodHandles.lookup().lookupClass()).a(189415754874378L);
    ...
    public IlIlur(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_CREATIVE_SLOT_ENABLED.IlIlt());
    }
        ...
        block9: {
            ...
            block7: {
                block8: {
                    l = b ^ 0x6170F223DE25L;
                    string = IlIlu7.IlIlq();
                    Object object2 = packetReceiveEvent.getPacketType();
                    if (string == null) {
                        if (object2 != IlIlnN.CREATIVE_INVENTORY_ACTION) {
                            return null;
                        }
                        object2 = packetReceiveEvent.getPlayer();
                    }
                    if (((Player)object2).getGameMode() != GameMode.CREATIVE) {
                        return new IlIlTE(this, (String)((Object)IlIlur.a("o", (int)1102, (long)(0x32B3E2D630F59703L ^ l))));
                    }
                    IlIlJZ ilIlJZ = new IlIlJZ(packetReceiveEvent);
                    n2 = n = ilIlJZ.IlIlq();
                    object = IlIlur.b("c", (int)24987, (long)(0x2939BE70828A8E16L ^ l));
                    if (string != null) break block7;
                    if (n2 < object) break block8;
                    n2 = n;
                    object = IlIlur.b("c", (int)21405, (long)(0x6E9E701E0E7FBC13L ^ l));
                    if (string != null) break block7;
            ...
            if (string == null) {
                ...
                n2 = n;
                object = IlIlur.b("c", (int)24709, (long)(0xBA84EE6EE4F0F0AL ^ l));
            }
            if (n2 == object) return null;
        }
        IlIlTV ilIlTV = new IlIlTV(this, (String)((Object)IlIlur.a("o", (int)7443, (long)(0x70861122BF970E5FL ^ l))) + n);
        return ilIlTV;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = IlIlur.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIlur", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIlur.e[n2] = IlIlur.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIlur" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlur.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlur.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
