...
@CP_jl(CP_J="Invalid Beacon", CP_M="Checks for invalid beacon packets")
public class CP_ua
extends CP_uV {
        ...
        block13: {
            ...
            block12: {
                ...
                block11: {
                        ...
                        block10: {
                            ...
                            block8: {
                                block7: {
                                    ...
                                    n2 = n3;
                                    object = CP_ua.b("k", (int)19745, (long)(0x36A69F0F9D6CD5D1L ^ l));
                                }
                                if (string != null) break block9;
                                if (n2 <= object) break block10;
                            }
                            return new CP_TE(this, (String)((Object)CP_ua.a("v", (int)6257, (long)(0x30FC833108869DA1L ^ l))) + n3);
                        }
                        n2 = n;
                        object = -1;
                    }
                    ...
                    n2 = n;
                    object = CP_ua.b("k", (int)2351, (long)(0x522DD1940B7591DEL ^ l));
                }
                if (n2 <= object) break block13;
            }
            return new CP_TE(this, (String)((Object)CP_ua.a("v", (int)17552, (long)(0x429CEC4804A1C141L ^ l))) + n);
        }
        return null;
    }
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_ua.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_ua", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            CP_ua.e[n2] = CP_ua.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_ua" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_ua.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
