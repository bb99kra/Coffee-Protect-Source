...
public class CP_PC
extends CP_Pw {
    private final CoffeeProtect CP_S;
    private final CP_AK<UUID> CP_Z;
    ...
    public CP_PC(CoffeeProtect coffeeProtect) {
        long l = a ^ 0x46002606A0CFL;
        super(CP_dF.LOWEST);
        this.CP_Z = new CP_AK((long)CP_PC.b("u", (int)7925, (long)(0x316D099177731ED4L ^ l)));
        this.CP_S = coffeeProtect;
                                        ...
                                        block43: {
                                            block44: {
                                                block42: {
                                                    block41: {
                                                        block54: {
                                                            var2_2 = CP_PC.a ^ 128433516513071L;
                                                            var4_3 = CP_vF.CP_o();
                                                            v0 /* !! */  = var1_1.getUser();
...
lbl54:
                                    ...
                                    if (v7 != CP_qy.PLUGIN_MESSAGE) ** GOTO lbl65
                                    var7_4 = new CP_J5(var1_1);
                                    var5_5 = var7_4.CP_K();
                                    var6_6 = var7_4.CP_h();
                                    try {
                                        if (var4_3 != null) break block46;
lbl65:
                            ...
                            v14 = v11.endsWith((String)CP_PC.a("k", (int)31686, (long)(2061613923750953110L ^ var2_2)));
                ...
                try {
                    block50: {
                        block51: {
                            ...
                            try {
                                block60: {
                                    if (v17.length() <= (int)CP_PC.e) break block51;
                                    break block60;
                                    catch (Exception v18) {
                                        throw CP_PC.a(v18);
                                    }
                        ...
                        v17 = CP_rW.CP_z(var10_8.substring(1));
                    }
                    var9_10 = v17;
                }
                catch (Exception var10_9) {
                    var1_1.setCancelled(true);
                    CP_Qb.CP_L((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$onPacketReceive$0(org.bukkit.entity.Player ), ()V)((Player)var7_4));
                    CP_rW.CP_U(new String[]{(String)CP_PC.a("k", (int)25347, (long)(3705249696198547541L ^ var2_2)) + var7_4.getName() + (String)CP_PC.a("k", (int)28512, (long)(7921576687229162549L ^ var2_2))});
                    return;
                }
                this.CP_Z.add(var8_7);
                var10_8 = this.CP_S.CP_F().CP_R((Player)var7_4);
                try {
                    try {
    ...
    private /* synthetic */ void lambda$onPacketReceive$2(UserData ilIlTM, String string, Player player) {
        block28: {
            ...
            block29: {
                ...
                block27: {
                    block26: {
                        block23: {
                            block24: {
                                block25: {
                                    ...
                                    block22: {
                                        l = a ^ 0x17D12BC79E0L;
                                        String[] stringArray2 = CP_vF.CP_o();
                                        ilIlTM.CP_R(string);
                                        stringArray = stringArray2;
                                        object = CP_Oq.CLIENT_SETTINGS_BANNED_CLIENTS.CP_T();
                                        try {
                                            list = object;
                                ...
                                bl = CP_Z6.CP_i(object, string::contains);
                            }
                            try {
                                try {
                                ...
                                CP_Qb.CP_L(() -> {
                                    ...
                                    player.kickPlayer(CP_xi.CLIENT_KICK.CP_F().replace((CharSequence)((Object)CP_PC.a("k", (int)8098, (long)(0x60F51AEEBE07B78CL ^ l))), string));
                                });
                                return;
                            }
                            catch (CheckException ilIlfF) {
                        ...
                        bl = CP_Oq.CLIENT_SETTINGS_ALERT_NON_VANILLA.CP_t();
                    }
                    try {
                        try {
                            try {
            ...
            for (UUID uUID : this.CP_S.CP_c().CP_F()) {
                Player player2;
                block30: {
    ...
    private static /* synthetic */ void lambda$onPacketReceive$0(Player player) {
        block7: {
            ...
            player2.kickPlayer((String)((Object)CP_PC.a("k", (int)31741, (long)(0x48EF38ECE032A27BL ^ l))));
        }
    }
        ...
        block18: {
            block17: {
                block19: {
                    block16: {
                        block15: {
                            CP_PC.a = CP_s.a(3557988327809697792L, -1722157644503866023L, MethodHandles.lookup().lookupClass()).a(227397306741959L);
                            CP_PC.d = new HashMap<K, V>(13);
                            var16 = CP_PC.a ^ 6294798002637L;
...
lbl25:
                            ...
                            while (true) {
                                var25_3[var23_4++] = CP_PC.a(var26_9).intern();
...
lbl65:
                ...
                ** while (true)
                CP_PC.e = ((long)var15_13[0] & 255L) << 56 | ((long)var15_13[1] & 255L) << 48 | ((long)var15_13[2] & 255L) << 40 | ((long)var15_13[3] & 255L) << 32 | ((long)var15_13[4] & 255L) << 24 | ((long)var15_13[5] & 255L) << 16 | ((long)var15_13[6] & 255L) << 8 | (long)var15_13[7] & 255L;
                CP_PC.h = new HashMap<K, V>(13);
...
lbl94:
    ...
    private static String a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/CP_PC", exception);
            }
            ...
            CP_PC.c[n2] = CP_PC.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return c[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/CP_PC" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_PC.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(CP_PC.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
