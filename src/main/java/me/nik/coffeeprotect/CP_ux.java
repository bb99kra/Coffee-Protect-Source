...
@CP_jl(CP_J="Invalid Select Trade", CP_M="Checks for invalid select trade packets")
public class CP_ux
extends CP_uV {
        ...
        block12: {
            ...
            block11: {
                ...
                block10: {
                    ...
                    return new CP_TV(this, (String)((Object)CP_ux.a("f", (int)20938, (long)(0x328EECDCC99D3A85L ^ l))) + n);
                }
            ...
            if (inventoryView.getType() != InventoryType.MERCHANT) {
                float f = this.CP_S;
                this.CP_S = f + 1.0f;
                return f > 1.0f ? new CP_TV(this, (String)((Object)CP_ux.a("f", (int)23327, (long)(0x40E9B5E9F487B051L ^ l)))) : new CP_TE(this, (String)((Object)CP_ux.a("f", (int)26833, (long)(0x783566667211039CL ^ l))));
            }
        }
        float f = this.CP_S;
        if (string == null) {
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = CP_ux.b(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        d = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            CP_ux.e[n2] = CP_ux.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(CP_ux.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
