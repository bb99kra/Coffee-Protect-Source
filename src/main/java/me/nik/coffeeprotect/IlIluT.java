 ...
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlJ2
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlJA
 *  me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIlJv
...
import me.nik.coffeeprotect.IlIlOp;
...
@IlIljl(IlIlJ="Invalid Window Click", IlIlM="Checks for invalid window click packets")
public class IlIluT
extends IlIluV {
    private long IlIlA;
    private long IlIlT;
    private int IlIlv;
    private IlIlCt IlIlr;
    private InventoryView IlIlK;
    ...
    public IlIluT(IlIlTM ilIlTM) {
        super(ilIlTM, IlIlOq.CHECKS_INVALID_WINDOW_CLICK_ENABLED.IlIlt());
    }
    ...
    public IlIlTV IlIlh(PacketReceiveEvent var1_1) {
        var2_2 = IlIluT.b ^ 39057855569527L;
        var4_3 = IlIlu7.IlIlq();
        ...
        if (var4_3 == null) {
            ...
            v0 = IlIlOp.IlIlg[((IlIlnN)var1_1.getPacketType()).ordinal()];
        }
        switch (v0 ? 1 : 0) {
            case 1: {
                var5_4 = new IlIlJ2(var1_1);
                var6_5 = (Player)var1_1.getPlayer();
                var7_6 = var6_5.getOpenInventory();
                var8_7 = var5_4.IlIlC();
                var9_8 = var5_4.IlIlN();
                var10_9 = var5_4.IlIlC();
                var11_10 = var5_4.IlIlF();
                var12_11 = this.IlIlv;
                this.IlIlv = var9_8;
                var13_12 = this.IlIlr;
                this.IlIlr = var8_7;
                var14_13 = this.IlIlK;
                this.IlIlK = var7_6;
                v1 = IlIlOq.CHECKS_INVALID_WINDOW_CLICK_PREVENT_SLOT_SPAM_IN_GUI.IlIlt();
                ...
                var15_14 = var1_1.IlIlO();
                var17_16 = var15_14 - this.IlIlA;
                cfr_temp_0 = var17_16 - IlIluT.c("s", (int)13089, (long)(1136099952360849211L ^ var2_2));
                v2 = cfr_temp_0 == 0L ? 0 : (cfr_temp_0 < 0L ? -1 : 1);
                if (var4_3 != null) ** GOTO lbl36
                if (v2 < 0) {
                    v2 = (cfr_temp_1 = this.IlIlT++ - IlIluT.c("s", (int)11770, (long)(8259089055191491042L ^ var2_2))) == 0L ? 0 : (cfr_temp_1 < 0L ? -1 : 1);
lbl36:
                    // 2 sources

                    if (var4_3 == null) {
                        if (v2 > 0) {
                            return new IlIlTE(this, (String)IlIluT.a("a", (int)23776, (long)(6789722631331156772L ^ var2_2)));
                        }
                        cfr_temp_2 = var17_16 - 0L;
                        v2 = cfr_temp_2 == 0L ? 0 : (cfr_temp_2 < 0L ? -1 : 1);
                    }
                    if (v2 == false) {
                        return new IlIlTE(this);
                    }
                } else {
                    this.IlIlT = Math.max(0L, this.IlIlT / IlIluT.c("s", (int)11918, (long)(876050492126257813L ^ var2_2)));
                }
                this.IlIlA = var15_14;
lbl46:
                // 3 sources

                v1 = (int)IlIlyR.IlIlq(new int[]{var9_8, var10_9, var11_10});
lbl47:
                // 3 sources

                if (v1 != 0) {
                    return new IlIlTV(this, (String)IlIluT.a("a", (int)7444, (long)(4588932610785235665L ^ var2_2)));
                }
                if (var8_7 != IlIlCt.SWAP) ** GOTO lbl57
                v3 = var9_8;
...
lbl56:
                ...
                return new IlIlTE(this, (String)IlIluT.a("a", (int)5311, (long)(2527359475348626294L ^ var2_2)) + var9_8 + (String)IlIluT.a("a", (int)10006, (long)(4524218550054316249L ^ var2_2)) + var10_9);
lbl57:
                // 2 sources

                v3 = IlIlOp.IlIlf[var8_7.ordinal()];
lbl58:
                // 2 sources
...
lbl62:
                        ...
                        v4 = IlIluT.b("n", (int)20855, (long)(232250825328876139L ^ var2_2));
                        if (var4_3 == null) {
                            if (v3 <= v4) {
                                v3 = var10_9;
                                if (var4_3 == null) {
                            ...
                            v4 = IlIluT.b("n", (int)6212, (long)(3082694641636709213L ^ var2_2));
                        }
                        if (v3 == v4) break;
                        return new IlIlTE(this, var8_7.name() + (String)IlIluT.a("a", (int)23210, (long)(6018870529202296164L ^ var2_2)) + var10_9);
                    }
                    case 2: {
                        v5 = var9_8;
...
lbl82:
                        ...
                        return new IlIlTE(this, var8_7.name() + (String)IlIluT.a("a", (int)7143, (long)(6666087126636680237L ^ var2_2)) + var9_8 + (String)IlIluT.a("a", (int)25591, (long)(3261280814880500791L ^ var2_2)) + var10_9);
                    }
                    case 3: 
                    case 4: 
                    case 5: {
...
lbl89:
                        ...
                        return new IlIlTE(this, var8_7.name() + (String)IlIluT.a("a", (int)17495, (long)(4943970990159661958L ^ var2_2)) + var10_9);
lbl90:
                        // 1 sources

                        if (var8_7 != IlIlCt.QUICK_MOVE) break;
                        v7 = var9_8;
                        if (var4_3 == null) {
                            if (v7 == IlIluT.b("n", (int)24616, (long)(4844559873671981872L ^ var2_2))) {
                                return new IlIlTE(this, var8_7.name() + (String)IlIluT.a("a", (int)8670, (long)(488860293831388691L ^ var2_2)) + var9_8);
                            }
                            v7 = var11_10;
                        }
                        if (var4_3 == null) {
                        ...
                        if (v7 >= 0) break;
                        return new IlIlTE(this, var8_7.name() + (String)IlIluT.a("a", (int)8670, (long)(488860293831388691L ^ var2_2)) + var9_8 + (String)IlIluT.a("a", (int)21212, (long)(6646069215065251098L ^ var2_2)) + var11_10);
                    }
                    case 6: {
                        v8 = var10_9;
                        v9 /* !! */  = 3;
                        ...
                        v8 = var10_9;
                        v9 /* !! */  = (int)IlIluT.b("n", (int)10502, (long)(5718335902053573148L ^ var2_2));
lbl108:
                        // 2 sources
                        ...
                        v9 /* !! */  = (int)IlIluT.b("n", (int)29132, (long)(71834326352952023L ^ var2_2));
lbl113:
                        // 2 sources
...
lbl116:
                    ...
                    case 8: {
                        return new IlIlTE(this, (String)IlIluT.a("a", (int)17078, (long)(2332260837028400497L ^ var2_2)));
                    }
                }
                if (var7_6 == null) {
                    return new IlIlTE(this, (String)IlIluT.a("a", (int)31511, (long)(6683206169244218567L ^ var2_2)));
                }
                v10 = var9_8;
                if (var4_3 != null) ** GOTO lbl139
                if (v10 >= 0) ** GOTO lbl138
                v10 = var9_8;
                v11 /* !! */  = (int)IlIluT.b("n", (int)868, (long)(4476357228298340474L ^ var2_2));
                ...
                if (v10 != v11 /* !! */ ) {
                    ...
                    if (var4_3 == null) {
                        if (v10 != v11 /* !! */ ) {
                            return new IlIlTV(this, (String)IlIluT.a("a", (int)9099, (long)(2266814881314925640L ^ var2_2)) + var9_8);
                        } else {
                            ** GOTO lbl138
                        }
                    } else {
...
lbl141:
                ...
                if (v10 < v11 /* !! */ ) {
                    return new IlIlTE(this, (String)IlIluT.a("a", (int)24034, (long)(6536844323664302638L ^ var2_2)) + var7_6.countSlots());
                }
                v10 = (int)IlIlOq.CHECKS_INVALID_WINDOW_CLICK_PREVENT_LECTERN_INVENTORY.IlIlt();
lbl144:
                // 2 sources

                if (var4_3 == null) {
                    if (v10 == 0) break;
                    v10 = (int)var7_6.getTopInventory().getType().name().equalsIgnoreCase((String)IlIluT.a("a", (int)1900, (long)(2504488736785123492L ^ var2_2)));
                }
                if (v10 == 0) break;
                return new IlIlTE(this);
            }
            case 2: {
                var15_15 = new IlIlJA(var1_1);
                v12 = var15_15.IlIls();
...
lbl156:
                ...
                return new IlIlTV(this, (String)IlIluT.a("a", (int)5517, (long)(8824830662190127695L ^ var2_2)) + var15_15.IlIls() + (String)IlIluT.a("a", (int)26761, (long)(1532232519581083458L ^ var2_2)) + var15_15.IlIlg());
            }
            case 3: {
                var16_18 = new IlIlJv(var1_1);
                v13 = var17_17 = var16_18.IlIlg();
...
lbl163:
                ...
                v14 = IlIluT.b("n", (int)19061, (long)(4117336834405941610L ^ var2_2));
                if (var4_3 == null) {
                    if (v13 <= v14) break;
                    v13 = var17_17;
                    v14 = IlIluT.b("n", (int)30193, (long)(6525136363820220140L ^ var2_2));
                }
                if (v13 == v14) break;
lbl169:
                // 2 sources

                return new IlIlTV(this, (String)IlIluT.a("a", (int)3505, (long)(2795013596266480240L ^ var2_2)) + var17_17);
            }
        }
        return null;
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                IlIluT.b = IlIls.a((long)-7994644512299029602L, (long)6067488787573586001L, MethodHandles.lookup().lookupClass()).a(8512756142942L);
                                IlIluT.f = new HashMap<K, V>(13);
                                var22 = IlIluT.b ^ 57365890296974L;
...
lbl25:
                                ...
                                while (true) {
                                    var31_3[var29_4++] = IlIluT.b(var32_9).intern();
...
lbl51:
                        ...
                        IlIluT.d = var31_3;
                        IlIluT.e = new String[18];
                        IlIluT.i = new HashMap<K, V>(13);
...
lbl104:
                ...
                IlIluT.g = var17_12;
                IlIluT.h = new Integer[8];
                IlIluT.l = new HashMap<K, V>(13);
...
lbl126:
    ...
    private static String a(int n, long l) {
        ...
        if (e[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/IlIluT", exception);
            }
            ...
            IlIluT.e[n2] = IlIluT.b(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return e[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/IlIluT" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static long c(int n, long l) {
        ...
        if (k[n2] == null) {
            ...
            byte[] byArray3 = new byte[]{(byte)(l2 >>> 56), (byte)(l2 >>> 48), (byte)(l2 >>> 40), (byte)(l2 >>> 32), (byte)(l2 >>> 24), (byte)(l2 >>> 16), (byte)(l2 >>> 8), (byte)l2};
            Long l3 = Thread.currentThread().getId();
            Object[] objectArray = (Object[])IlIluT.l.get(l3);
            try {
                if (objectArray == null) {
                    objectArray = new Object[]{Cipher.getInstance("DES/CBC/NoPadding"), SecretKeyFactory.getInstance("DES"), new IvParameterSpec(new byte[8])};
                    IlIluT.l.put(l3, objectArray);
                }
                DESKeySpec dESKeySpec = new DESKeySpec(byArray2);
                SecretKey secretKey = ((SecretKeyFactory)objectArray[1]).generateSecret(dESKeySpec);
                Cipher cipher = (Cipher)objectArray[0];
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIluT.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIluT.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_2() {
        try {
            return MethodHandles.lookup().findStatic(IlIluT.class, "c", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)J", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
